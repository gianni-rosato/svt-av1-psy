...
static INLINE void load_buffer_8x8_sse4_1(const int16_t *input, __m128i *in,
    int32_t stride, int32_t flipud, int32_t fliplr,
    int32_t shift) {
    __m128i u;
    if (!flipud) {
...
static INLINE void write_buffer_8x8_sse4_1(const __m128i *res, int32_t *output) {
    _mm_store_si128((__m128i *)(output + 0 * 4), res[0]);
    _mm_store_si128((__m128i *)(output + 1 * 4), res[1]);
    _mm_store_si128((__m128i *)(output + 2 * 4), res[2]);
    _mm_store_si128((__m128i *)(output + 3 * 4), res[3]);
...
static INLINE void load_buffer_16x16_sse4_1(const int16_t *input, __m128i *out,
    int32_t stride, int32_t flipud, int32_t fliplr,
    int32_t shift) {
    __m128i in[64];
    // Load 4 8x8 blocks
    ...
    load_buffer_8x8_sse4_1(topL, &in[0], stride, flipud, fliplr, shift);
    load_buffer_8x8_sse4_1(botL, &in[32], stride, flipud, fliplr, shift);

    // load second 8 columns
    load_buffer_8x8_sse4_1(topR, &in[16], stride, flipud, fliplr, shift);
    load_buffer_8x8_sse4_1(botR, &in[48], stride, flipud, fliplr, shift);
