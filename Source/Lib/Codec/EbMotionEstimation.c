...

    {
        ...
        if (validL) {
            ...
            dist = (context_ptr->fractionalSearchMethod == SSD_SEARCH) ?
                CombinedAveragingSSD_funcPtrArray[asm_type](&(context_ptr->sb_buffer[puLcuBufferIndex]), BLOCK_SIZE_64, buf1[0] + searchRegionIndex1, buf1Stride[0], buf2[0] + searchRegionIndex2, buf2Stride[0], pu_height, pu_width) :
                (context_ptr->fractionalSearchMethod == SUB_SAD_SEARCH) ?
...
#if M0_SSD_HALF_QUARTER_PEL_BIPRED_SEARCH
            dist = (context_ptr->fractionalSearchMethod == SSD_SEARCH) ?
                CombinedAveragingSSD_funcPtrArray[asm_type](&(context_ptr->sb_buffer[puLcuBufferIndex]), BLOCK_SIZE_64, buf1[1] + searchRegionIndex1, buf1Stride[1], buf2[1] + searchRegionIndex2, buf2Stride[1], pu_height, pu_width) :
                (context_ptr->fractionalSearchMethod == SUB_SAD_SEARCH) ?
...
#if M0_SSD_HALF_QUARTER_PEL_BIPRED_SEARCH
            dist = (context_ptr->fractionalSearchMethod == SSD_SEARCH) ?
                CombinedAveragingSSD_funcPtrArray[asm_type](&(context_ptr->sb_buffer[puLcuBufferIndex]), BLOCK_SIZE_64, buf1[2] + searchRegionIndex1, buf1Stride[2], buf2[2] + searchRegionIndex2, buf2Stride[2], pu_height, pu_width) :
                (context_ptr->fractionalSearchMethod == SUB_SAD_SEARCH) ?
...
#if M0_SSD_HALF_QUARTER_PEL_BIPRED_SEARCH
            dist = (context_ptr->fractionalSearchMethod == SSD_SEARCH) ?
                CombinedAveragingSSD_funcPtrArray[asm_type](&(context_ptr->sb_buffer[puLcuBufferIndex]), BLOCK_SIZE_64, buf1[3] + searchRegionIndex1, buf1Stride[3], buf2[3] + searchRegionIndex2, buf2Stride[3], pu_height, pu_width) :
                (context_ptr->fractionalSearchMethod == SUB_SAD_SEARCH) ?
...
#if M0_SSD_HALF_QUARTER_PEL_BIPRED_SEARCH
            dist = (context_ptr->fractionalSearchMethod == SSD_SEARCH) ?
                CombinedAveragingSSD_funcPtrArray[asm_type](&(context_ptr->sb_buffer[puLcuBufferIndex]), BLOCK_SIZE_64, buf1[4] + searchRegionIndex1, buf1Stride[4], buf2[4] + searchRegionIndex2, buf2Stride[4], pu_height, pu_width) :
                (context_ptr->fractionalSearchMethod == SUB_SAD_SEARCH) ?
...
#if M0_SSD_HALF_QUARTER_PEL_BIPRED_SEARCH
            dist = (context_ptr->fractionalSearchMethod == SSD_SEARCH) ?
                CombinedAveragingSSD_funcPtrArray[asm_type](&(context_ptr->sb_buffer[puLcuBufferIndex]), BLOCK_SIZE_64, buf1[5] + searchRegionIndex1, buf1Stride[5], buf2[5] + searchRegionIndex2, buf2Stride[5], pu_height, pu_width) : \
                (context_ptr->fractionalSearchMethod == SUB_SAD_SEARCH) ?
...
#if M0_SSD_HALF_QUARTER_PEL_BIPRED_SEARCH
            dist = (context_ptr->fractionalSearchMethod == SSD_SEARCH) ?
                CombinedAveragingSSD_funcPtrArray[asm_type](&(context_ptr->sb_buffer[puLcuBufferIndex]), BLOCK_SIZE_64, buf1[6] + searchRegionIndex1, buf1Stride[6], buf2[6] + searchRegionIndex2, buf2Stride[6], pu_height, pu_width) :
                (context_ptr->fractionalSearchMethod == SUB_SAD_SEARCH) ?
...
#if M0_SSD_HALF_QUARTER_PEL_BIPRED_SEARCH
            dist = (context_ptr->fractionalSearchMethod == SSD_SEARCH) ?
                CombinedAveragingSSD_funcPtrArray[asm_type](&(context_ptr->sb_buffer[puLcuBufferIndex]), BLOCK_SIZE_64, buf1[7] + searchRegionIndex1, buf1Stride[7], buf2[7] + searchRegionIndex2, buf2Stride[7], pu_height, pu_width) :
                (context_ptr->fractionalSearchMethod == SUB_SAD_SEARCH) ?
