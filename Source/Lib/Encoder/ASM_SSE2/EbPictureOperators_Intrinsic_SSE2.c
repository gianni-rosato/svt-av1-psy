...
void picture_addition_kernel16bit_sse2_intrin(uint16_t *pred_ptr, uint32_t pred_stride,
    ...
    __m128i xmm_0, xmm_max_10bit;

    uint32_t y, x;

    xmm_0         = _mm_setzero_si128();
    xmm_max_10bit = _mm_set1_epi16(1023);

    if (width == 4) {
        __m128i xmm_sum_0_3, xmm_sum_s0_s3, xmm_clip3_0_3, xmm_clip3_s0_s3;
        for (y = 0; y < height; y += 2) {
            xmm_sum_0_3 = _mm_adds_epi16(_mm_loadl_epi64((__m128i *)pred_ptr),
                                         _mm_loadl_epi64((__m128i *)residual_ptr));
            xmm_sum_s0_s3 =
                _mm_adds_epi16(_mm_loadl_epi64((__m128i *)(pred_ptr + pred_stride)),
                               _mm_loadl_epi64((__m128i *)(residual_ptr + residual_stride)));

            xmm_clip3_0_3   = _mm_max_epi16(_mm_min_epi16(xmm_sum_0_3, xmm_max_10bit), xmm_0);
            xmm_clip3_s0_s3 = _mm_max_epi16(_mm_min_epi16(xmm_sum_s0_s3, xmm_max_10bit), xmm_0);
        ...
        for (y = 0; y < height; y += 2) {
            xmm_sum_0_7 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)pred_ptr),
                                         _mm_loadu_si128((__m128i *)residual_ptr));
            xmm_sum_s0_s7 =
                _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride)),
                               _mm_loadu_si128((__m128i *)(residual_ptr + residual_stride)));

            xmm_clip3_0_7   = _mm_max_epi16(_mm_min_epi16(xmm_sum_0_7, xmm_max_10bit), xmm_0);
            xmm_clip3_s0_s7 = _mm_max_epi16(_mm_min_epi16(xmm_sum_s0_s7, xmm_max_10bit), xmm_0);
        ...
        __m128i sum_0_7, sum_8_15, sum_s0_s7, sum_s8_s15, clip3_0_7, clip3_8_15, clip3_s0_s7,
            clip3_s8_s15;

        for (y = 0; y < height; y += 2) {
            sum_0_7  = _mm_adds_epi16(_mm_loadu_si128((__m128i *)pred_ptr),
                                     _mm_loadu_si128((__m128i *)residual_ptr));
            sum_8_15 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + 8)),
                                      _mm_loadu_si128((__m128i *)(residual_ptr + 8)));
            sum_s0_s7 =
                _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride)),
                               _mm_loadu_si128((__m128i *)(residual_ptr + residual_stride)));
            sum_s8_s15 =
                _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride + 8)),
                               _mm_loadu_si128((__m128i *)(residual_ptr + residual_stride + 8)));

            clip3_0_7    = _mm_max_epi16(_mm_min_epi16(sum_0_7, xmm_max_10bit), xmm_0);
            clip3_8_15   = _mm_max_epi16(_mm_min_epi16(sum_8_15, xmm_max_10bit), xmm_0);
            clip3_s0_s7  = _mm_max_epi16(_mm_min_epi16(sum_s0_s7, xmm_max_10bit), xmm_0);
            clip3_s8_s15 = _mm_max_epi16(_mm_min_epi16(sum_s8_s15, xmm_max_10bit), xmm_0);
        ...
        __m128i sum_0_7, sum_8_15, sum_16_23, sum_24_31, sum_s0_s7, sum_s8_s15, sum_s16_s23,
            sum_s24_s31;
        __m128i clip3_0_7, clip3_8_15, clip3_16_23, clip3_24_31, clip3_s0_s7, clip3_s8_s15,
            clip3_s16_s23, clip3_s24_s31;
        ...
        for (y = 0; y < height; y += 2) {
            ...
            sum_8_15  = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + 8)),
                                      _mm_loadu_si128((__m128i *)(residual_ptr + 8)));
            sum_16_23 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + 16)),
                                       _mm_loadu_si128((__m128i *)(residual_ptr + 16)));
            sum_24_31 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + 24)),
                                       _mm_loadu_si128((__m128i *)(residual_ptr + 24)));
            ...
            sum_s8_s15 =
                _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride + 8)),
                               _mm_loadu_si128((__m128i *)(residual_ptr + residual_stride + 8)));
            sum_s16_s23 =
                _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride + 16)),
                               _mm_loadu_si128((__m128i *)(residual_ptr + residual_stride + 16)));
            sum_s24_s31 =
                _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride + 24)),
                               _mm_loadu_si128((__m128i *)(residual_ptr + residual_stride + 24)));

            clip3_0_7   = _mm_max_epi16(_mm_min_epi16(sum_0_7, xmm_max_10bit), xmm_0);
            clip3_8_15  = _mm_max_epi16(_mm_min_epi16(sum_8_15, xmm_max_10bit), xmm_0);
            clip3_16_23 = _mm_max_epi16(_mm_min_epi16(sum_16_23, xmm_max_10bit), xmm_0);
            clip3_24_31 = _mm_max_epi16(_mm_min_epi16(sum_24_31, xmm_max_10bit), xmm_0);

            clip3_s0_s7   = _mm_max_epi16(_mm_min_epi16(sum_s0_s7, xmm_max_10bit), xmm_0);
            clip3_s8_s15  = _mm_max_epi16(_mm_min_epi16(sum_s8_s15, xmm_max_10bit), xmm_0);
            clip3_s16_s23 = _mm_max_epi16(_mm_min_epi16(sum_s16_s23, xmm_max_10bit), xmm_0);
            clip3_s24_s31 = _mm_max_epi16(_mm_min_epi16(sum_s24_s31, xmm_max_10bit), xmm_0);
        ...
        __m128i clip3_0_7, clip3_8_15, clip3_16_23, clip3_24_31, clip3_32_39, clip3_40_47,
            clip3_48_55, clip3_56_63;
        ...
        for (y = 0; y < height; ++y) {
            ...
            sum_24_31 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + 24)),
                                       _mm_loadu_si128((__m128i *)(residual_ptr + 24)));
            sum_32_39 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + 32)),
                                       _mm_loadu_si128((__m128i *)(residual_ptr + 32)));
            sum_40_47 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + 40)),
                                       _mm_loadu_si128((__m128i *)(residual_ptr + 40)));
            sum_48_55 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + 48)),
                                       _mm_loadu_si128((__m128i *)(residual_ptr + 48)));
            sum_56_63 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + 56)),
                                       _mm_loadu_si128((__m128i *)(residual_ptr + 56)));

            clip3_0_7   = _mm_max_epi16(_mm_min_epi16(sum_0_7, xmm_max_10bit), xmm_0);
            clip3_8_15  = _mm_max_epi16(_mm_min_epi16(sum_8_15, xmm_max_10bit), xmm_0);
            clip3_16_23 = _mm_max_epi16(_mm_min_epi16(sum_16_23, xmm_max_10bit), xmm_0);
            clip3_24_31 = _mm_max_epi16(_mm_min_epi16(sum_24_31, xmm_max_10bit), xmm_0);
            clip3_32_39 = _mm_max_epi16(_mm_min_epi16(sum_32_39, xmm_max_10bit), xmm_0);
            clip3_40_47 = _mm_max_epi16(_mm_min_epi16(sum_40_47, xmm_max_10bit), xmm_0);
            clip3_48_55 = _mm_max_epi16(_mm_min_epi16(sum_48_55, xmm_max_10bit), xmm_0);
            clip3_56_63 = _mm_max_epi16(_mm_min_epi16(sum_56_63, xmm_max_10bit), xmm_0);
        ...
        if (!(width & 7)) {
            ...
            for (x = 0; x < height; x += 2) {
                for (y = 0; y < width; y += 8) {
                    xmm_sum_0_7   = _mm_adds_epi16(_mm_loadu_si128((__m128i *)pred_ptr),
                                                 _mm_loadu_si128((__m128i *)residual_ptr));
                    xmm_sum_s0_s7 = _mm_adds_epi16(
                        _mm_loadu_si128((__m128i *)(pred_ptr + pred_stride)),
                        _mm_loadu_si128((__m128i *)(residual_ptr + residual_stride)));

                    xmm_clip3_0_7 = _mm_max_epi16(_mm_min_epi16(xmm_sum_0_7, xmm_max_10bit), xmm_0);
                    xmm_clip3_s0_s7 =
                        _mm_max_epi16(_mm_min_epi16(xmm_sum_s0_s7, xmm_max_10bit), xmm_0);
            ...
            for (x = 0; x < height; x += 2) {
                for (y = 0; y < width; y += 4) {
                    ...
                    xmm_clip3_0_3 = _mm_max_epi16(_mm_min_epi16(xmm_sum_0_7, xmm_max_10bit), xmm_0);
                    xmm_clip3_s0_s3 =
                        _mm_max_epi16(_mm_min_epi16(xmm_sum_s0_s7, xmm_max_10bit), xmm_0);
