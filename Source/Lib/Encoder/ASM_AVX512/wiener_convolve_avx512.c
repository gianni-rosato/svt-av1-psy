...
SIMD_INLINE __m512i wiener_clip_avx512(const __m512i s, const __m512i r,
    const __m512i filt_center,
    const __m512i round_h0,
    const __m512i round_h1,
...
static INLINE __m512i wiener_convolve_tap3_avx512(
    const __m512i s, const __m512i coeffs[2], const __m512i filt[2],
    ...
    return wiener_clip_avx512(
        s, res, filt_center, round_h0, round_h1, clamp_high);
}

SIMD_INLINE __m512i wiener_convolve_tap5_avx512(
    const __m512i s, const __m512i coeffs[3], const __m512i filt[3],
    const __m512i filt_center, const __m512i round_h0, const __m512i round_h1,
    const __m512i clamp_high) {
...
static INLINE __m512i wiener_convolve_tap7_avx512(
    const __m512i s, const __m512i coeffs[4], const __m512i filt[4],
    const __m512i filt_center, const __m512i round_h0, const __m512i round_h1,
    const __m512i clamp_high) {
...
SIMD_INLINE __m512i wiener_convolve_h16x2_tap3_avx512(
    const uint8_t* src, const ptrdiff_t stride, const __m512i coeffs[2],
...
SIMD_INLINE __m512i wiener_convolve_h16x2_tap5_avx512(
    const uint8_t* src, const ptrdiff_t stride, const __m512i coeffs[3],
...
static INLINE __m512i wiener_convolve_h16x2_tap7_avx512(
    const uint8_t* src, const ptrdiff_t stride, const __m512i coeffs[4],
...
SIMD_INLINE __m512i wiener_convolve_h32_tap3_avx512(
    const uint8_t* src, const __m512i coeffs[2], const __m512i filt[2],
    const __m512i filt_center, const __m512i round_h0, const __m512i round_h1,
    const __m512i clamp_high) {
...
static INLINE __m512i wiener_convolve_h32_tap5_avx512(
    const uint8_t* src, const __m512i coeffs[3], const __m512i filt[3],
    const __m512i filt_center, const __m512i round_h0, const __m512i round_h1,
    const __m512i clamp_high) {
    const __m512i s = zz_loadu_512(src);
    return wiener_convolve_tap5_avx512(
...
static INLINE __m512i wiener_convolve_h32_tap7_avx512(
    const uint8_t* src, const __m512i coeffs[4], const __m512i filt[4],
    const __m512i filt_center, const __m512i round_h0, const __m512i round_h1,
    const __m512i clamp_high) {
    const __m512i s = zz_loadu_512(src);
    return wiener_convolve_tap7_avx512(
...
SIMD_INLINE void wiener_convolve_h32x2_tap3(
    const uint8_t* src, const ptrdiff_t stride, const __m512i coeffs[2],
    const __m512i filt[2], const __m512i filt_center, const __m512i round_h0,
    const __m512i round_h1, const __m512i clamp_high, __m512i* const dst0,
    __m512i* const dst1) {
    *dst0 = wiener_convolve_h16x2_tap3_avx512(src + 0,
        stride,
        coeffs,
        filt,
        filt_center,
        ...
        round_h1,
        clamp_high);
    *dst1 = wiener_convolve_h16x2_tap3_avx512(src + 8,
        stride,
        coeffs,
        filt,
        filt_center,
...
SIMD_INLINE void wiener_convolve_h32x2_tap5(
    const uint8_t* src, const ptrdiff_t stride, const __m512i coeffs[3],
    const __m512i filt[3], const __m512i filt_center, const __m512i round_h0,
    const __m512i round_h1, const __m512i clamp_high, __m512i* const dst0,
    __m512i* const dst1) {
    *dst0 = wiener_convolve_h16x2_tap5_avx512(src + 0,
        stride,
        coeffs,
        filt,
        filt_center,
        ...
        round_h1,
        clamp_high);
    *dst1 = wiener_convolve_h16x2_tap5_avx512(src + 8,
        stride,
        coeffs,
        filt,
        filt_center,
...
SIMD_INLINE void wiener_convolve_h32x2_tap7(
    const uint8_t* src, const ptrdiff_t stride, const __m512i coeffs[4],
    const __m512i filt[4], const __m512i filt_center, const __m512i round_h0,
    const __m512i round_h1, const __m512i clamp_high, __m512i* const dst0,
    __m512i* const dst1) {
    *dst0 = wiener_convolve_h16x2_tap7_avx512(src + 0,
        stride,
        coeffs,
        filt,
        filt_center,
        ...
        round_h1,
        clamp_high);
    *dst1 = wiener_convolve_h16x2_tap7_avx512(src + 8,
        stride,
        coeffs,
        filt,
        filt_center,
...
static INLINE void wiener_convolve_h64_tap3(
    const uint8_t* src, const __m512i coeffs[2], const __m512i filt[2],
    const __m512i filt_center, const __m512i round_h0, const __m512i round_h1,
...
static INLINE void wiener_convolve_h64_tap5(
    const uint8_t* src, const __m512i coeffs[3], const __m512i filt[3],
    const __m512i filt_center, const __m512i round_h0, const __m512i round_h1,
    const __m512i clamp_high, __m512i* const dst0, __m512i* const dst1) {
...
static INLINE void wiener_convolve_h64_tap7_avx512(
    const uint8_t* src, const __m512i coeffs[4], const __m512i filt[4],
    const __m512i filt_center, const __m512i round_h0, const __m512i round_h1,
    const __m512i clamp_high, __m512i* const dst0, __m512i* const dst1) {
...
static INLINE __m512i round_store_avx512(const __m512i res0, const __m512i res1,
    ...
    const __m512i r0 =
        _mm512_srai_epi32(_mm512_add_epi32(res0, round_v), round_1);
    const __m512i r1 =
        _mm512_srai_epi32(_mm512_add_epi32(res1, round_v), round_1);
    return _mm512_packs_epi32(r0, r1);
}

SIMD_INLINE __m512i wiener_convolve_v_tap3_kernel_avx512(
    const __m512i coeffs[2], const __m512i round_v, const __m512i s[3]) {
...
SIMD_INLINE __m512i wiener_convolve_v_tap5_kernel_avx512(
    const __m512i coeffs[2], const __m512i round_v, const __m512i s[5]) {
...
SIMD_INLINE __m512i wiener_convolve_v_tap7_kernel_avx512(
    const __m512i coeffs[2], const __m512i round_v, const __m512i s[7]) {
...
SIMD_INLINE __m512i wiener_convolve_v16x2_tap3(const __m512i coeffs[2],
    const __m512i round_v,
    __m512i s[3]) {
    const __m512i dst =
        wiener_convolve_v_tap3_kernel_avx512(coeffs, round_v, s);
    s[0] = s[2];
    return dst;
}

SIMD_INLINE __m512i wiener_convolve_v16x2_tap5(const __m512i coeffs[2],
    const __m512i round_v,
    __m512i s[5]) {
    const __m512i dst =
        wiener_convolve_v_tap5_kernel_avx512(coeffs, round_v, s);
    s[0] = s[2];
    s[1] = s[3];
    s[2] = s[4];
    return dst;
...
SIMD_INLINE __m512i wiener_convolve_v16x2_tap7(const __m512i coeffs[2],
    const __m512i round_v,
    __m512i s[7]) {
    const __m512i dst =
        wiener_convolve_v_tap7_kernel_avx512(coeffs, round_v, s);
    s[0] = s[2];
    s[1] = s[3];
    s[2] = s[4];
    s[3] = s[5];
...
SIMD_INLINE __m512i wiener_convolve_v32_tap3(const __m512i coeffs[2],
    const __m512i round_v,
    __m512i s[3]) {
    const __m512i dst =
        wiener_convolve_v_tap3_kernel_avx512(coeffs, round_v, s);
...
static INLINE __m512i wiener_convolve_v32_tap5(const __m512i coeffs[2],
    const __m512i round_v,
    __m512i s[5]) {
    const __m512i dst =
        wiener_convolve_v_tap5_kernel_avx512(coeffs, round_v, s);
...
static INLINE __m512i wiener_convolve_v32_tap7(const __m512i coeffs[2],
    const __m512i round_v,
    __m512i s[7]) {
    const __m512i dst =
        wiener_convolve_v_tap7_kernel_avx512(coeffs, round_v, s);
...
static INLINE void pack_store_32x2_avx512(const __m512i res0,
    const __m512i res1,
    uint8_t* const dst,
...
void eb_av1_wiener_convolve_add_src_avx512(
    ...
    const __m256i round_h1 =
        _mm256_set1_epi16((1 << (bd + FILTER_BITS - round_0 - 1)));
    const __m512i round_h1_512 =
        _mm512_set1_epi16((1 << (bd + FILTER_BITS - round_0 - 1)));
    const __m256i round_v =
        _mm256_set1_epi32((1 << (round_1 - 1)) - (1 << (bd + round_1 - 1)));
    const __m512i round_v_512 =
        _mm512_set1_epi32((1 << (round_1 - 1)) - (1 << (bd + round_1 - 1)));
    const __m256i clamp_high =
        _mm256_set1_epi16(WIENER_CLAMP_LIMIT(round_0, bd) - 1);
    const __m512i clamp_high_512 =
        _mm512_set1_epi16(WIENER_CLAMP_LIMIT(round_0, bd) - 1);
    ...
    if (!cnt_zero_coef) {
        ...
        if (width >= 32) {
            ...
            const __m512i filt_center_512 =
                zz_load_512(filt_center_tap7_global_avx);
            ...
            while (x) {
                ...
                do {
                    wiener_convolve_h64_tap7_avx512(src_p,
                        ...
                        &s[1][6]);
                    src_p += src_stride;
                    const __m512i r0 = wiener_convolve_v32_tap7(
                        coeffs_v_512, round_v_512, s[0]);
                    const __m512i r1 = wiener_convolve_v32_tap7(
                        coeffs_v_512, round_v_512, s[1]);
            ...
            if (x) {
                ...
                s[0][1] =
                    _mm512_setr_m256i(_mm512_extracti64x4_epi64(s[0][0], 1),
                        _mm512_castsi512_si256(s[0][2]));
                s[1][1] =
                    _mm512_setr_m256i(_mm512_extracti64x4_epi64(s[1][0], 1),
                        _mm512_castsi512_si256(s[1][2]));
                s[0][3] =
                    _mm512_setr_m256i(_mm512_extracti64x4_epi64(s[0][2], 1),
                        _mm512_castsi512_si256(s[0][4]));
                s[1][3] =
                    _mm512_setr_m256i(_mm512_extracti64x4_epi64(s[1][2], 1),
                ...
                do {
                    wiener_convolve_h32x2_tap7(src_p,
                        ...
                        &s[1][6]);
                    s[0][5] =
                        _mm512_setr_m256i(_mm512_extracti64x4_epi64(s[0][4], 1),
                            _mm512_castsi512_si256(s[0][6]));
                    s[1][5] =
                        _mm512_setr_m256i(_mm512_extracti64x4_epi64(s[1][4], 1),
                            _mm512_castsi512_si256(s[1][6]));
                    src_p += 2 * src_stride;
                    const __m512i r0 = wiener_convolve_v16x2_tap7(
                        coeffs_v_512, round_v_512, s[0]);
                    const __m512i r1 = wiener_convolve_v16x2_tap7(
                        coeffs_v_512, round_v_512, s[1]);
        ...
        if (width >= 16) {
            ...
            do {
                wiener_convolve_h16x2_tap7(src_p,
                    ...
                    &s[1][6]);
                s[0][5] =
                    _mm256_setr_m128i(_mm256_extracti128_si256(s[0][4], 1),
                        _mm256_castsi256_si128(s[0][6]));
                s[1][5] =
                    _mm256_setr_m128i(_mm256_extracti128_si256(s[1][4], 1),
                        _mm256_castsi256_si128(s[1][6]));
                src_p += 2 * src_stride;
                const __m256i r0 =
                    wiener_convolve_v8x2_tap7(coeffs_v, round_v, s[0]);
                const __m256i r1 =
                    wiener_convolve_v8x2_tap7(coeffs_v, round_v, s[1]);
        ...
        if (width) {
            ...
            s[0] = wiener_convolve_h8x2_tap7(src_p,
                src_stride,
                coeffs_h,
                filt,
                filt_center,
                ...
                clamp_high);
            src_p += 2 * src_stride;
            s[2] = wiener_convolve_h8x2_tap7(src_p,
                src_stride,
                coeffs_h,
                filt,
                filt_center,
                ...
                clamp_high);
            src_p += 2 * src_stride;
            s[4] = wiener_convolve_h8x2_tap7(src_p,
                src_stride,
                coeffs_h,
                filt,
                filt_center,
            ...
            int y = h;
            do {
                s[6] = wiener_convolve_h8x2_tap7(src_p,
                    src_stride,
                    coeffs_h,
                    filt,
                    filt_center,
                ...
                src_p += 2 * src_stride;
                const __m256i r =
                    wiener_convolve_v8x2_tap7(coeffs_v, round_v, s);
        ...
        if (width >= 32) {
            ...
            const __m512i filt_center_512 =
                zz_load_512(filt_center_tap5_global_avx);
            filt_512[2] = zz_load_512(filt3_global_avx);
            populate_coeffs_6tap_avx512(coeffs_x, coeffs_h_512);
            // coeffs 1 2 1 2 1 2 1 2
            coeffs_v_512[0] = _mm512_shuffle_epi8(
                filter_coeffs_y_512, _mm512_set1_epi32(0x05040302u));
            // coeffs 3 4 3 4 3 4 3 4
            coeffs_v_512[1] = _mm512_shuffle_epi8(
                filter_coeffs_y_512, _mm512_set1_epi32(0x09080706u));
            ...
            while (x) {
                ...
                do {
                    wiener_convolve_h64_tap5(src_p,
                        ...
                        &s[1][4]);
                    src_p += src_stride;
                    const __m512i r0 = wiener_convolve_v32_tap5(
                        coeffs_v_512, round_v_512, s[0]);
                    const __m512i r1 = wiener_convolve_v32_tap5(
                        coeffs_v_512, round_v_512, s[1]);
                    convolve_store_64_avx512(r0, r1, dst_ptr + y * dst_stride);
                } while (++y < h);
                ...
                do {
                    ...
                    s[1][3] =
                        _mm512_setr_m256i(_mm512_extracti64x4_epi64(s[1][2], 1),
                            _mm512_castsi512_si256(s[1][4]));
                    src_p += 2 * src_stride;
                    const __m512i r0 = wiener_convolve_v16x2_tap5(
                        coeffs_v_512, round_v_512, s[0]);
                    const __m512i r1 = wiener_convolve_v16x2_tap5(
                        coeffs_v_512, round_v_512, s[1]);
                    pack_store_32x2_avx512(r0, r1, dst_p, dst_stride);
        ...
        // coeffs 1 2 1 2 1 2 1 2
        coeffs_v[0] = _mm256_shuffle_epi8(filter_coeffs_y,
            _mm256_set1_epi32(0x05040302u));
        // coeffs 3 4 3 4 3 4 3 4
        coeffs_v[1] = _mm256_shuffle_epi8(filter_coeffs_y,
            _mm256_set1_epi32(0x09080706u));
        ...
        if (width >= 16) {
            ...
            do {
                wiener_convolve_h16x2_tap5(src_p,
                    ...
                    &s[1][4]);
                s[0][3] =
                    _mm256_setr_m128i(_mm256_extracti128_si256(s[0][2], 1),
                        _mm256_castsi256_si128(s[0][4]));
                s[1][3] =
                    _mm256_setr_m128i(_mm256_extracti128_si256(s[1][2], 1),
                        _mm256_castsi256_si128(s[1][4]));
                src_p += 2 * src_stride;
                const __m256i r0 =
                    wiener_convolve_v8x2_tap5(coeffs_v, round_v, s[0]);
                const __m256i r1 =
                    wiener_convolve_v8x2_tap5(coeffs_v, round_v, s[1]);
                pack_store_16x2_avx2(r0, r1, dst_p, dst_stride);
        ...
        if (width) {
            ...
            s[0] = wiener_convolve_h8x2_tap5(src_p,
                src_stride,
                coeffs_h,
                filt,
                filt_center,
                ...
                clamp_high);
            src_p += 2 * src_stride;
            s[2] = wiener_convolve_h8x2_tap5(src_p,
                src_stride,
                coeffs_h,
                filt,
                filt_center,
            ...
            int y = h;
            do {
                s[4] = wiener_convolve_h8x2_tap5(src_p,
                    src_stride,
                    coeffs_h,
                    filt,
                    filt_center,
                ...
                src_p += 2 * src_stride;
                const __m256i r =
                    wiener_convolve_v8x2_tap5(coeffs_v, round_v, s);
                pack_store_8x2_avx2(r, dst_ptr, dst_stride);
        ...
        if (width >= 32) {
            ...
            const __m512i filt_center_512 =
                zz_load_512(filt_center_tap3_global_avx);
            ...
            while (x) {
                ...
                do {
                    wiener_convolve_h64_tap3(src_p,
                        ...
                        &s[1][2]);
                    src_p += src_stride;
                    const __m512i r0 = wiener_convolve_v32_tap3(
                        coeffs_v_512, round_v_512, s[0]);
                    const __m512i r1 = wiener_convolve_v32_tap3(
                        coeffs_v_512, round_v_512, s[1]);
                    convolve_store_64_avx512(r0, r1, dst_ptr + y * dst_stride);
                } while (++y < h);
                ...
                do {
                    ...
                    s[1][1] =
                        _mm512_setr_m256i(_mm512_extracti64x4_epi64(s[1][0], 1),
                            _mm512_castsi512_si256(s[1][2]));
                    src_p += 2 * src_stride;
                    const __m512i r0 = wiener_convolve_v16x2_tap3(
                        coeffs_v_512, round_v_512, s[0]);
                    const __m512i r1 = wiener_convolve_v16x2_tap3(
                        coeffs_v_512, round_v_512, s[1]);
                    pack_store_32x2_avx512(r0, r1, dst_p, dst_stride);
        ...
        if (width >= 16) {
            ...
            do {
                wiener_convolve_h16x2_tap3(src_p,
                    ...
                    &s[1][2]);
                s[0][1] =
                    _mm256_setr_m128i(_mm256_extracti128_si256(s[0][0], 1),
                        _mm256_castsi256_si128(s[0][2]));
                s[1][1] =
                    _mm256_setr_m128i(_mm256_extracti128_si256(s[1][0], 1),
                        _mm256_castsi256_si128(s[1][2]));
                src_p += 2 * src_stride;
                const __m256i r0 =
                    wiener_convolve_v8x2_tap3(coeffs_v, round_v, s[0]);
                const __m256i r1 =
                    wiener_convolve_v8x2_tap3(coeffs_v, round_v, s[1]);
                pack_store_16x2_avx2(r0, r1, dst_p, dst_stride);
        ...
        if (width) {
            ...
            s[0] = wiener_convolve_h8x2_tap3(src_p,
                src_stride,
                coeffs_h,
                filt,
                filt_center,
            ...
            int y = h;
            do {
                s[2] = wiener_convolve_h8x2_tap3(src_p,
                    src_stride,
                    coeffs_h,
                    filt,
                    filt_center,
                ...
                src_p += 2 * src_stride;
                const __m256i r =
                    wiener_convolve_v8x2_tap3(coeffs_v, round_v, s);
                pack_store_8x2_avx2(r, dst_ptr, dst_stride);
