...
DECLARE_ALIGNED(64, static const uint8_t, filt_center_tap5_global_avx[64]) = {
    2, 255, 3, 255, 4, 255, 5, 255, 6, 255, 7, 255, 8, 255, 9, 255,
    2, 255, 3, 255, 4, 255, 5, 255, 6, 255, 7, 255, 8, 255, 9, 255,
    2, 255, 3, 255, 4, 255, 5, 255, 6, 255, 7, 255, 8, 255, 9, 255,
    2, 255, 3, 255, 4, 255, 5, 255, 6, 255, 7, 255, 8, 255, 9, 255 };
...
static INLINE int calc_zero_coef(const int16_t* const filter_x,
...
static INLINE __m256i wiener_clip(const __m256i s, const __m256i r,
    const __m256i filt_center,
    const __m256i round_h0,
...
SIMD_INLINE __m256i wiener_convolve_tap3(
    const __m256i s, const __m256i coeffs[2], const __m256i filt[2],
...
static INLINE __m256i wiener_convolve_tap5(
    const __m256i s, const __m256i coeffs[3], const __m256i filt[3],
    const __m256i filt_center, const __m256i round_h0, const __m256i round_h1,
    const __m256i clamp_high) {
...
static INLINE __m256i wiener_convolve_tap7(
    const __m256i s, const __m256i coeffs[4], const __m256i filt[4],
    const __m256i filt_center, const __m256i round_h0, const __m256i round_h1,
    const __m256i clamp_high) {
...
static INLINE __m256i wiener_convolve_h8x2_tap3(
    const uint8_t* src, const ptrdiff_t stride, const __m256i coeffs[2],
    ...
    return wiener_convolve_tap3(
        s, coeffs, filt, filt_center, round_h0, round_h1, clamp_high);
}

static INLINE __m256i wiener_convolve_h8x2_tap5(
    const uint8_t* src, const ptrdiff_t stride, const __m256i coeffs[3],
    const __m256i filt[3], const __m256i filt_center, const __m256i round_h0,
    const __m256i round_h1, const __m256i clamp_high) {
    const __m256i s = loadu_8bit_16x2_avx2(src, stride);
    return wiener_convolve_tap5(
        s, coeffs, filt, filt_center, round_h0, round_h1, clamp_high);
}

static INLINE __m256i wiener_convolve_h8x2_tap7(
    const uint8_t* src, const ptrdiff_t stride, const __m256i coeffs[4],
    const __m256i filt[4], const __m256i filt_center, const __m256i round_h0,
    const __m256i round_h1, const __m256i clamp_high) {
    const __m256i s = loadu_8bit_16x2_avx2(src, stride);
    return wiener_convolve_tap7(
        s, coeffs, filt, filt_center, round_h0, round_h1, clamp_high);
}

SIMD_INLINE void wiener_convolve_h16x2_tap3(
    const uint8_t* src, const ptrdiff_t stride, const __m256i coeffs[2],
    const __m256i filt[2], const __m256i filt_center, const __m256i round_h0,
    const __m256i round_h1, const __m256i clamp_high, __m256i* const dst0,
    __m256i* const dst1) {
    *dst0 = wiener_convolve_h8x2_tap3(src + 0,
        stride,
        coeffs,
        filt,
        filt_center,
        ...
        round_h1,
        clamp_high);
    *dst1 = wiener_convolve_h8x2_tap3(src + 8,
        stride,
        coeffs,
        filt,
        filt_center,
...
SIMD_INLINE void wiener_convolve_h16x2_tap5(
    const uint8_t* src, const ptrdiff_t stride, const __m256i coeffs[3],
    const __m256i filt[3], const __m256i filt_center, const __m256i round_h0,
    const __m256i round_h1, const __m256i clamp_high, __m256i* const dst0,
    __m256i* const dst1) {
    *dst0 = wiener_convolve_h8x2_tap5(src + 0,
        stride,
        coeffs,
        filt,
        filt_center,
        ...
        round_h1,
        clamp_high);
    *dst1 = wiener_convolve_h8x2_tap5(src + 8,
        stride,
        coeffs,
        filt,
        filt_center,
...
SIMD_INLINE void wiener_convolve_h16x2_tap7(
    const uint8_t* src, const ptrdiff_t stride, const __m256i coeffs[4],
    const __m256i filt[4], const __m256i filt_center, const __m256i round_h0,
    const __m256i round_h1, const __m256i clamp_high, __m256i* const dst0,
    __m256i* const dst1) {
    *dst0 = wiener_convolve_h8x2_tap7(src + 0,
        stride,
        coeffs,
        filt,
        filt_center,
        ...
        round_h1,
        clamp_high);
    *dst1 = wiener_convolve_h8x2_tap7(src + 8,
        stride,
        coeffs,
        filt,
        filt_center,
...
static INLINE __m256i round_store(const __m256i res0, const __m256i res1,
    const __m256i round_v) {
    const int round_1 = 2 * FILTER_BITS - WIENER_ROUND0_BITS;
    const __m256i r0 =
        _mm256_srai_epi32(_mm256_add_epi32(res0, round_v), round_1);
    const __m256i r1 =
        _mm256_srai_epi32(_mm256_add_epi32(res1, round_v), round_1);
    return _mm256_packs_epi32(r0, r1);
}

SIMD_INLINE __m256i wiener_convolve_v_tap3_kernel(const __m256i coeffs[2],
    const __m256i round_v,
    const __m256i s[3]) {
...
SIMD_INLINE __m256i wiener_convolve_v_tap5_kernel(const __m256i coeffs[2],
    const __m256i round_v,
    const __m256i s[5]) {
...
SIMD_INLINE __m256i wiener_convolve_v_tap7_kernel(const __m256i coeffs[2],
    const __m256i round_v,
    const __m256i s[7]) {
...
SIMD_INLINE __m256i wiener_convolve_v8x2_tap3(const __m256i coeffs[2],
    const __m256i round_v,
    __m256i s[3]) {
...
SIMD_INLINE __m256i wiener_convolve_v8x2_tap5(const __m256i coeffs[2],
    const __m256i round_v,
    __m256i s[5]) {
...
static INLINE __m256i wiener_convolve_v8x2_tap7(const __m256i coeffs[2],
    const __m256i round_v,
    __m256i s[7]) {
