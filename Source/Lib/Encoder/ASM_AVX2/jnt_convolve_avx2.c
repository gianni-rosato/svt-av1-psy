...
static INLINE void jnt_y_avg_2tap_32_avx2(const uint8_t *const src,
...
static INLINE void jnt_y_no_avg_2tap_32_avx2(
...
static void jnt_convolve_y_2tap_avx2(
        ...
        if (conv_params->use_jnt_comp_avg) {
            ...
            if (w <= 4) {
                ...
                const __m128i offset_comp_avg_128 =
                    _mm_set1_epi32(offset_comp_avg);
                ...
                const __m256i offset_comp_avg_256 =
                    _mm256_set1_epi32(offset_comp_avg);
            ...
            const int16_t offset_avg = (1 << (FILTER_BITS - 1)) +
                (1 << (round_1 - bits - 2)) -
            ...
            if (w <= 4) {
                ...
                if (w == 2) {
                    ...
                    do {
                        const __m128i res = y_convolve_2tap_2x2_ssse3(
                            src_ptr, src_stride, coeffs_128, s_16);
                        jnt_avg_round_store_2x2_sse2(res,
                            offset_avg_128,
                            dst,
                            dst_stride,
                            dst8,
                    ...
                    do {
                        const __m128i res = y_convolve_2tap_4x2_ssse3(
                            src_ptr, src_stride, coeffs_128, s_32);
                        jnt_avg_round_store_4x2_sse2(res,
                            offset_avg_128,
                            dst,
                            dst_stride,
                            dst8,
                ...
                if (w == 8) {
                    ...
                    do {
                        const __m256i res = y_convolve_2tap_8x2_avx2(
                            src_ptr, src_stride, coeffs_256, s_64);
                        jnt_avg_round_store_8x2_avx2(res,
                            offset_avg_256,
                            dst,
                            dst_stride,
                            dst8,
                    ...
                    do {
                        y_convolve_2tap_16x2_avx2(
                            src_ptr, src_stride, coeffs_256, s_128, r);
                        jnt_avg_round_store_16x2_avx2(r,
                            offset_avg_256,
                            dst,
                            dst_stride,
                            dst8,
        ...
        if (w <= 4) {
            ...
            if (w == 2) {
                ...
                do {
                    const __m128i res = y_convolve_2tap_2x2_ssse3(
                        src_ptr, src_stride, coeffs_128, s_16);
                    jnt_no_avg_round_store_2x2_sse2(
                ...
                do {
                    const __m128i res = y_convolve_2tap_4x2_ssse3(
                        src_ptr, src_stride, coeffs_128, s_32);
                    jnt_no_avg_round_store_4x2_sse2(
                        res, offset_no_avg_128, dst, dst_stride);
                    src_ptr += 2 * src_stride;
                    dst += 2 * dst_stride;
                    y -= 2;
            ...
            if (w == 8) {
                ...
                do {
                    const __m256i res = y_convolve_2tap_8x2_avx2(
                        src_ptr, src_stride, coeffs_256, s_64);
                    jnt_no_avg_round_store_8x2_avx2(
                ...
                do {
                    y_convolve_2tap_16x2_avx2(
                        src_ptr, src_stride, coeffs_256, s_128, r);
                    jnt_no_avg_round_store_16x2_avx2(
...
static void jnt_convolve_y_6tap_avx2(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
    const InterpFilterParams *const filter_params_y, const int32_t subpel_y_q4,
    const ConvolveParams *const conv_params) {
                    ...
                    do {
                        ...
                        do {
                            ...
                            jnt_avg_round_store_32_avx2(
                                r, offset_avg_256, d, d8);
                            jnt_avg_round_store_32_avx2(r + 2,
                                offset_avg_256,
                                d + dst_stride,
                                d8 + dst8_stride);
            ...
            if (w == 8) {
                ...
                do {
                    ...
                    do {
                        ...
                        jnt_no_avg_round_store_32_avx2(
...
static void jnt_convolve_y_8tap_avx2(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
    const InterpFilterParams *const filter_params_y, const int32_t subpel_y_q4,
    const ConvolveParams *const conv_params) {
            ...
            if (w <= 4) {
                ...
                if (w == 2) {
                    ...
                    s_16[5] = _mm_cvtsi32_si128(
                        *(int16_t *)(src_ptr + 5 * src_stride));
                    s_16[6] = _mm_cvtsi32_si128(
                        *(int16_t *)(src_ptr + 6 * src_stride));
                    ...
                    s_32[5] = _mm_cvtsi32_si128(
                        *(int32_t *)(src_ptr + 5 * src_stride));
                    s_32[6] = _mm_cvtsi32_si128(
                        *(int32_t *)(src_ptr + 6 * src_stride));
...
void eb_av1_jnt_convolve_y_avx2(const uint8_t *src, int32_t src_stride,
    ...
    jnt_convolve_y_tap_func_table[tap_y](src,
        src_stride,
        dst8,
        dst8_stride,
        w,
...
static INLINE void jnt_copy_avg_32_avx2(const uint8_t *const src,
        ...
        if (conv_params->use_jnt_comp_avg) {
            ...
            if (w <= 4) {
                ...
                if (w == 2) {
                    do {
                        const __m128i res =
                            jnt_copy_load_src_2x2_sse2(src, src_stride);
                    ...
                    do {
                        const __m128i res =
                            jnt_copy_load_src_4x2_sse4_1(src, src_stride);
                ...
                if (w == 8) {
                    do {
                        const __m256i res =
                            jnt_copy_load_src_8x2_avx2(src, src_stride);
                    ...
                    do {
                        jnt_copy_comp_avg_32_avx2(
                            src, factor_256, offset_comp_avg_256, dst, dst8);
                        src += src_stride;
                        dst += dst_stride;
                        dst8 += dst8_stride;
                    } while (--h);
            ...
            if (w <= 4) {
                ...
                if (w == 2) {
                    do {
                        const __m128i res =
                            jnt_copy_load_src_2x2_sse2(src, src_stride);
                        jnt_copy_avg_round_store_2x2_sse2(res,
                            offset_avg_128,
                            dst,
                            dst_stride,
                            dst8,
                    ...
                    do {
                        const __m128i res =
                            jnt_copy_load_src_4x2_sse4_1(src, src_stride);
                        jnt_copy_avg_round_store_4x2_sse2(res,
                            offset_avg_128,
                            dst,
                            dst_stride,
                            dst8,
                ...
                if (w == 8) {
                    do {
                        const __m256i res =
                            jnt_copy_load_src_8x2_avx2(src, src_stride);
                        jnt_copy_avg_round_store_8x2_avx2(res,
                            offset_avg_256,
                            dst,
                            dst_stride,
                            dst8,
                    ...
                    do {
                        ...
                        res[0] = jnt_copy_load_src_16_avx2(src);
                        res[1] = jnt_copy_load_src_16_avx2(src + src_stride);
                        jnt_copy_avg_round_store_16x2_avx2(res,
                            offset_avg_256,
                            dst,
                            dst_stride,
                            dst8,
                    ...
                    do {
                        jnt_copy_avg_32_avx2(src + 0 * 32,
                            offset_avg_256,
                            dst + 0 * 32,
                            dst8 + 0 * 32);
                        jnt_copy_avg_32_avx2(src + 1 * 32,
                            offset_avg_256,
                            dst + 1 * 32,
                            dst8 + 1 * 32);
                        src += src_stride;
                    ...
                    do {
                        ...
                        jnt_copy_avg_32_avx2(src + 1 * 32,
                            ...
                            dst + 1 * 32,
                            dst8 + 1 * 32);
                        jnt_copy_avg_32_avx2(src + 2 * 32,
                            offset_avg_256,
                            dst + 2 * 32,
                            dst8 + 2 * 32);
                        jnt_copy_avg_32_avx2(src + 3 * 32,
                            offset_avg_256,
                            dst + 3 * 32,
                            dst8 + 3 * 32);
                        src += src_stride;
        ...
        if (w <= 4) {
            ...
            if (w == 8) {
                ...
                do {
                    ...
                    d[0] = _mm256_add_epi16(d[0], offset_no_avg_256);
                    d[1] = _mm256_add_epi16(d[1], offset_no_avg_256);
                    _mm256_storeu_si256((__m256i *)(dst + 0 * dst_stride),
                        d[0]);
                    _mm256_storeu_si256((__m256i *)(dst + 1 * dst_stride),
                        d[1]);
                    src += 2 * src_stride;
                    dst += 2 * dst_stride;
                    h -= 2;
                ...
                do {
                    jnt_copy_no_avg_32_avx2(
                        src + 0 * 32, offset_no_avg_256, dst + 0 * 32);
                    jnt_copy_no_avg_32_avx2(
                        src + 1 * 32, offset_no_avg_256, dst + 1 * 32);
                    src += src_stride;
                    dst += dst_stride;
                } while (--h);
            }
                ...
                do {
                    ...
                    jnt_copy_no_avg_32_avx2(
                        src + 1 * 32, offset_no_avg_256, dst + 1 * 32);
                    jnt_copy_no_avg_32_avx2(
                        src + 2 * 32, offset_no_avg_256, dst + 2 * 32);
                    jnt_copy_no_avg_32_avx2(
                        src + 3 * 32, offset_no_avg_256, dst + 3 * 32);
                    src += src_stride;
                    dst += dst_stride;
                } while (--h);
            }
...
SIMD_INLINE void jnt_x_comp_avg_2tap_32_avx2(
    const uint8_t *const src, const __m256i *const coeffs, const __m256i factor,
...
static INLINE void jnt_x_avg_2tap_32_avx2(const uint8_t *const src,
    const __m256i *const coeffs,
    const __m256i offset,
    const ConvBufType *const dst,
    uint8_t *const dst8) {
...
static INLINE void jnt_x_no_avg_2tap_32_avx2(const uint8_t *const src,
    const __m256i *const coeffs,
    const __m256i offset,
...
SIMD_INLINE void jnt_x_comp_avg_6tap_16x2_avx2(
    const uint8_t *const src, const int32_t src_stride, const __m256i coeffs[3],
    const __m256i filt[3], const __m256i factor, const __m256i offset,
...
SIMD_INLINE void jnt_x_avg_6tap_16x2_avx2(
    const uint8_t *const src, const int32_t src_stride, const __m256i coeffs[3],
    ...
    jnt_avg_round_store_16x2_avx2(
        r, offset, dst, dst_stride, dst8, dst8_stride);
}

SIMD_INLINE void jnt_x_no_avg_6tap_16x2_avx2(
    const uint8_t *const src, const int32_t src_stride, const __m256i coeffs[3],
    const __m256i filt[3], const __m256i offset, ConvBufType *const dst,
...
SIMD_INLINE void jnt_x_comp_avg_6tap_32_avx2(
    const uint8_t *const src, const __m256i coeffs[3], const __m256i filt[3],
...
SIMD_INLINE void jnt_x_avg_6tap_32_avx2(
    const uint8_t *const src, const __m256i coeffs[3], const __m256i filt[3],
    const __m256i offset, ConvBufType *const dst, uint8_t *const dst8) {
    __m256i r[2];
...
SIMD_INLINE void jnt_x_no_avg_6tap_32_avx2(const uint8_t *const src,
...
static INLINE void jnt_x_comp_avg_8tap_16x2_avx2(
    const uint8_t *const src, const int32_t src_stride, const __m256i coeffs[4],
    const __m256i filt[4], const __m256i factor, const __m256i offset,
    ConvBufType *const dst, const int32_t dst_stride, uint8_t *const dst8,
    const int32_t dst8_stride) {
    __m256i r[2];
...
SIMD_INLINE void jnt_x_comp_avg_8tap_32_avx2(
    const uint8_t *const src, const __m256i coeffs[4], const __m256i filt[4],
    const __m256i factor, const __m256i offset, ConvBufType *const dst,
    uint8_t *const dst8) {
    __m256i r[2];
...
SIMD_INLINE void jnt_x_avg_8tap_16x2_avx2(
    const uint8_t *const src, const int32_t src_stride, const __m256i coeffs[4],
...
SIMD_INLINE void jnt_x_avg_8tap_32_avx2(
    const uint8_t *const src, const __m256i coeffs[4], const __m256i filt[4],
    const __m256i offset, ConvBufType *const dst, uint8_t *const dst8) {
    __m256i r[2];
...
static INLINE void jnt_x_no_avg_8tap_16x2_avx2(
    const uint8_t *const src, const int32_t src_stride, const __m256i coeffs[4],
    const __m256i filt[4], const __m256i offset, ConvBufType *const dst,
    const int32_t dst_stride) {
    __m256i r[2];
...
SIMD_INLINE void jnt_x_no_avg_8tap_32_avx2(const uint8_t *const src,
...
static void jnt_convolve_x_2tap_avx2(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
        ...
        if (conv_params->use_jnt_comp_avg) {
            ...
            if (w <= 4) {
                ...
                if (w == 8) {
                    ...
                    do {
                        jnt_x_comp_avg_2tap_32_avx2(src_ptr,
                            coeffs_256,
                            factor_256,
                            offset_comp_avg_256,
                            dst,
            ...
            if (w <= 4) {
                ...
                if (w == 8) {
                    ...
                    do {
                        jnt_x_avg_2tap_32_avx2(
                            src_ptr, coeffs_256, offset_avg_256, dst, dst8);
                        jnt_x_avg_2tap_32_avx2(src_ptr + 32,
                            coeffs_256,
                            offset_avg_256,
                            dst + 32,
                            dst8 + 32);
        ...
        if (w <= 4) {
            ...
            if (w == 8) {
                ...
                do {
                    jnt_x_no_avg_2tap_32_avx2(
                        src_ptr, coeffs_256, offset_no_avg_256, dst);
                    jnt_x_no_avg_2tap_32_avx2(src_ptr + 1 * 32,
                        coeffs_256,
                        offset_no_avg_256,
                        dst + 1 * 32);
                    jnt_x_no_avg_2tap_32_avx2(src_ptr + 2 * 32,
                        coeffs_256,
                        offset_no_avg_256,
                        dst + 2 * 32);
                    jnt_x_no_avg_2tap_32_avx2(src_ptr + 3 * 32,
                        coeffs_256,
                        offset_no_avg_256,
                        dst + 3 * 32);
                    src_ptr += src_stride;
...
void jnt_convolve_x_4tap_ssse3(const uint8_t *const src,
    ...
    if (conv_params->do_average) {
        if (conv_params->use_jnt_comp_avg) {
            ...
            if (w == 2) {
                do {
                    const __m128i res = x_convolve_4tap_2x2_ssse3(
                        src_ptr, src_stride, coeffs_128);
                    jnt_comp_avg_round_store_2x2_sse2(res,
                        factor_128,
                        offset_comp_avg_128,
                ...
                do {
                    const __m128i res = x_convolve_4tap_4x2_ssse3(
                        src_ptr, src_stride, coeffs_128);
                    jnt_comp_avg_round_store_4x2_sse2(res,
                        factor_128,
                        offset_comp_avg_128,
...
static void jnt_convolve_x_6tap_avx2(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
    const InterpFilterParams *const filter_params_x, const int32_t subpel_x_q4,
    const ConvolveParams *const conv_params) {
    ...
    if (conv_params->do_average) {
        if (conv_params->use_jnt_comp_avg) {
            ...
            if (w == 8) {
                ...
                do {
                    jnt_x_comp_avg_6tap_32_avx2(src_ptr,
                        coeffs_256,
                        filt_256,
                        factor_256,
                        offset_comp_avg_256,
            ...
            if (w == 8) {
                ...
                do {
                    jnt_x_avg_6tap_32_avx2(src_ptr,
                        coeffs_256,
                        filt_256,
                        offset_avg_256,
                        dst,
                ...
                do {
                    jnt_x_avg_6tap_32_avx2(src_ptr,
                        ...
                        dst,
                        dst8);
                    jnt_x_avg_6tap_32_avx2(src_ptr + 32,
                        coeffs_256,
                        filt_256,
                        offset_avg_256,
                        dst + 32,
        ...
        if (w == 8) {
            ...
            do {
                jnt_x_no_avg_6tap_32_avx2(
                    src_ptr, coeffs_256, filt_256, offset_no_avg_256, dst);
                src_ptr += src_stride;
                dst += dst_stride;
            } while (--y);
        }
            ...
            do {
                jnt_x_no_avg_6tap_32_avx2(
                    src_ptr, coeffs_256, filt_256, offset_no_avg_256, dst);
                jnt_x_no_avg_6tap_32_avx2(src_ptr + 32,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
                    dst + 32);
            ...
            do {
                jnt_x_no_avg_6tap_32_avx2(
                    src_ptr, coeffs_256, filt_256, offset_no_avg_256, dst);
                jnt_x_no_avg_6tap_32_avx2(src_ptr + 1 * 32,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
                    dst + 1 * 32);
                jnt_x_no_avg_6tap_32_avx2(src_ptr + 2 * 32,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
                    dst + 2 * 32);
                jnt_x_no_avg_6tap_32_avx2(src_ptr + 3 * 32,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
                    dst + 3 * 32);
...
static void jnt_convolve_x_8tap_avx2(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
    const InterpFilterParams *const filter_params_x, const int32_t subpel_x_q4,
    const ConvolveParams *const conv_params) {
    ...
    if (conv_params->do_average) {
        if (conv_params->use_jnt_comp_avg) {
            ...
            if (w == 8) {
                ...
                do {
                    jnt_x_comp_avg_8tap_32_avx2(src_ptr,
                        coeffs_256,
                        filt_256,
                        factor_256,
                        offset_comp_avg_256,
            ...
            if (w == 8) {
                ...
                do {
                    jnt_x_avg_8tap_32_avx2(src_ptr,
                        coeffs_256,
                        filt_256,
                        offset_avg_256,
                        dst,
                ...
                do {
                    jnt_x_avg_8tap_32_avx2(src_ptr,
                        ...
                        dst,
                        dst8);
                    jnt_x_avg_8tap_32_avx2(src_ptr + 32,
                        coeffs_256,
                        filt_256,
                        offset_avg_256,
                        dst + 32,
        ...
        if (w == 8) {
            ...
            do {
                jnt_x_no_avg_8tap_32_avx2(
                    src_ptr, coeffs_256, filt_256, offset_no_avg_256, dst);
                jnt_x_no_avg_8tap_32_avx2(src_ptr + 32,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
                    dst + 32);
            ...
            do {
                jnt_x_no_avg_8tap_32_avx2(
                    src_ptr, coeffs_256, filt_256, offset_no_avg_256, dst);
                jnt_x_no_avg_8tap_32_avx2(src_ptr + 1 * 32,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
                    dst + 1 * 32);
                jnt_x_no_avg_8tap_32_avx2(src_ptr + 2 * 32,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
                    dst + 2 * 32);
                jnt_x_no_avg_8tap_32_avx2(src_ptr + 3 * 32,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
                    dst + 3 * 32);
...
void eb_av1_jnt_convolve_x_avx2(const uint8_t *src, int32_t src_stride,
    ...
    jnt_convolve_x_tap_func_table[tap_x](src,
        src_stride,
        dst8,
        dst8_stride,
        w,
