...
int32_t sum_residual8bit_avx2_intrin(int16_t *in_ptr, uint32_t size, uint32_t stride_in) {
    ...
    if (size == 4) { //SSSE3
        ...
        sum0 = _mm256_add_epi16(_mm256_loadu_si256((__m256i *)(in_ptr_temp)),
                                _mm256_loadu_si256((__m256i *)(in_ptr_temp + 16)));
        sum1 = _mm256_add_epi16(_mm256_loadu_si256((__m256i *)(in_ptr_temp + 32)),
                                _mm256_loadu_si256((__m256i *)(in_ptr_temp + 48)));
        sum2 = _mm256_add_epi16(_mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in)),
                                _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 16)));
        sum3 = _mm256_add_epi16(_mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 32)),
                                _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 48)));

        in_ptr_temp += 2 * stride_in;

        sum4 = _mm256_add_epi16(_mm256_loadu_si256((__m256i *)(in_ptr_temp)),
                                _mm256_loadu_si256((__m256i *)(in_ptr_temp + 16)));
        sum5 = _mm256_add_epi16(_mm256_loadu_si256((__m256i *)(in_ptr_temp + 32)),
                                _mm256_loadu_si256((__m256i *)(in_ptr_temp + 48)));
        sum6 = _mm256_add_epi16(_mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in)),
                                _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 16)));
        sum7 = _mm256_add_epi16(_mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 32)),
                                _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 48)));
        ...
        for (row_index = 4; row_index < 64; row_index += 4) { // Parse every four rows
            sum0 = _mm256_add_epi16(sum0, _mm256_loadu_si256((__m256i *)(in_ptr_temp)));
            sum1 = _mm256_add_epi16(sum1, _mm256_loadu_si256((__m256i *)(in_ptr_temp + 16)));
            sum2 = _mm256_add_epi16(sum2, _mm256_loadu_si256((__m256i *)(in_ptr_temp + 32)));
            sum3 = _mm256_add_epi16(sum3, _mm256_loadu_si256((__m256i *)(in_ptr_temp + 48)));

            sum0 = _mm256_add_epi16(sum0, _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in)));
            sum1 = _mm256_add_epi16(sum1,
                                    _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 16)));
            sum2 = _mm256_add_epi16(sum2,
                                    _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 32)));
            sum3 = _mm256_add_epi16(sum3,
                                    _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 48)));

            in_ptr_temp += 2 * stride_in;

            sum4 = _mm256_add_epi16(sum4, _mm256_loadu_si256((__m256i *)(in_ptr_temp)));
            sum5 = _mm256_add_epi16(sum5, _mm256_loadu_si256((__m256i *)(in_ptr_temp + 16)));
            sum6 = _mm256_add_epi16(sum6, _mm256_loadu_si256((__m256i *)(in_ptr_temp + 32)));
            sum7 = _mm256_add_epi16(sum7, _mm256_loadu_si256((__m256i *)(in_ptr_temp + 48)));

            sum4 = _mm256_add_epi16(sum4, _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in)));
            sum5 = _mm256_add_epi16(sum5,
                                    _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 16)));
            sum6 = _mm256_add_epi16(sum6,
                                    _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 32)));
            sum7 = _mm256_add_epi16(sum7,
                                    _mm256_loadu_si256((__m256i *)(in_ptr_temp + stride_in + 48)));
        ...
        sum_block = _mm_cvtsi128_si32(
            _mm_add_epi32(_mm256_castsi256_si128(sum0), _mm256_extracti128_si256(sum0, 1)));
...
void picture_addition_kernel8x8_av1_sse2_intrin(uint8_t *pred_ptr, uint32_t pred_stride,
    ...
    __m128i  pred_reg_128, pred_reg128_lo, pred_reg128_hi, xmm0_128, recon_0_7_128;
    uint32_t y;
    xmm0_128 = _mm_setzero_si128();
    xmm0     = _mm256_setzero_si256();

    for (y = 0; y < 8; ++y) {
        pred_reg_128           = _mm_cvtsi64_si128(*(uint64_t *)pred_ptr);
        pred_reg_128           = _mm_unpacklo_epi8(pred_reg_128, xmm0_128);
        pred_reg128_lo         = _mm_unpacklo_epi16(pred_reg_128, xmm0_128);
        pred_reg128_hi         = _mm_unpackhi_epi16(pred_reg_128, xmm0_128);
...
void picture_addition_kernel16x16_av1_sse2_intrin(uint8_t *pred_ptr, uint32_t pred_stride,
                                                  ...
                                                  uint8_t *recon_ptr, uint32_t recon_stride,
                                                  uint32_t width, uint32_t height, int32_t bd) {
    __m256i res_reg, recon_0_7, xmm0, predRegLo, predRegHi, res_reg_lo, res_reg_hi;
    __m128i pred_reg_128, pred_reg128_lo, pred_reg128_hi, xmm0_128, pred_reg_128_lo_16_lo,
        pred_reg_128_lo_16_hi, pred_reg_128_hi_16_lo, pred_reg_128_hi_16_hi;
    uint32_t y;
    xmm0_128 = _mm_setzero_si128();
    xmm0     = _mm256_setzero_si256();

    for (y = 0; y < 16; ++y) {
        pred_reg_128          = _mm_loadu_si128((__m128i *)pred_ptr);
        pred_reg128_lo        = _mm_unpacklo_epi8(pred_reg_128, xmm0_128);
        pred_reg128_hi        = _mm_unpackhi_epi8(pred_reg_128, xmm0_128);
        pred_reg_128_lo_16_lo = _mm_unpacklo_epi16(pred_reg128_lo, xmm0_128);
        pred_reg_128_lo_16_hi = _mm_unpackhi_epi16(pred_reg128_lo, xmm0_128);
        pred_reg_128_hi_16_lo = _mm_unpacklo_epi16(pred_reg128_hi, xmm0_128);
        pred_reg_128_hi_16_hi = _mm_unpackhi_epi16(pred_reg128_hi, xmm0_128);
        predRegLo             = _mm256_set_m128i(pred_reg_128_lo_16_hi, pred_reg_128_lo_16_lo);
        predRegHi             = _mm256_set_m128i(pred_reg_128_hi_16_hi, pred_reg_128_hi_16_lo);
        res_reg_lo            = _mm256_loadu_si256((__m256i *)residual_ptr);
        res_reg_hi            = _mm256_loadu_si256((__m256i *)(residual_ptr + 8));
        predRegLo             = _mm256_add_epi32(predRegLo, res_reg_lo);
        predRegHi             = _mm256_add_epi32(predRegHi, res_reg_hi);
        res_reg               = _mm256_packus_epi32(predRegLo, predRegHi);
...
void picture_addition_kernel32x32_av1_sse2_intrin(uint8_t *pred_ptr, uint32_t pred_stride,
                                                  ...
                                                  uint8_t *recon_ptr, uint32_t recon_stride,
                                                  uint32_t width, uint32_t height, int32_t bd) {
    __m256i pred_reg, recon_0_7, xmm0, res_reg, pred_reg_lo, pred_reg_hi, pred_reg_lo16_lo,
        pred_reg_lo16_hi, pred_reg_hi16_lo, pred_reg_hi16_hi, res_reg1, res_reg2, res_reg3,
        res_reg4;
    ...
    for (y = 0; y < 32; ++y) {
        ...
        pred_reg_lo      = _mm256_set_m128i(_mm256_castsi256_si128(pred_reg_lo16_hi),
                                       _mm256_castsi256_si128(pred_reg_lo16_lo));
        pred_reg_hi      = _mm256_set_m128i(_mm256_castsi256_si128(pred_reg_hi16_hi),
                                       _mm256_castsi256_si128(pred_reg_hi16_lo));
        pred_reg_lo16_lo = _mm256_set_m128i(_mm256_extracti128_si256(pred_reg_lo16_hi, 1),
                                            _mm256_extracti128_si256(pred_reg_lo16_lo, 1));
        pred_reg_hi16_hi = _mm256_set_m128i(_mm256_extracti128_si256(pred_reg_hi16_hi, 1),
                                            _mm256_extracti128_si256(pred_reg_hi16_lo, 1));
