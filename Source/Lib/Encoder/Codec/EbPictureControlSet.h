...
typedef struct PaletteCtrls {
    uint8_t enabled;
    uint8_t dominant_color_step; // In the dominant color search, test a subset of the most dominant color combinations by testing every nth combo. E.g. with step size of 2, if the
