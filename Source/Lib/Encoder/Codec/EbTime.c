...
void eb_injector(uint64_t processed_frame_count, uint32_t injector_frame_rate) {
#ifdef _WIN32
    ...
    if (first_time == 0) {
        ...
        eb_compute_overall_elapsed_time(startTimesSeconds,
                                        startTimesuSeconds,
                                        currentTimesSeconds,
