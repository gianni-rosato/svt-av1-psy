...
extern EbErrorType clip_mv(uint32_t blk_org_x, uint32_t blk_org_y, int16_t *mv_x, int16_t *mv_y,
                           uint32_t picture_width, uint32_t picture_height, uint32_t tb_size);
void               init_xd(PictureControlSet *pcs, struct ModeDecisionContext *ctx);
void               generate_av1_mvp_table(struct ModeDecisionContext *ctx, BlkStruct *blk_ptr,
                                          const BlockGeom *blk_geom, uint16_t blk_org_x, uint16_t blk_org_y,
                                          MvReferenceFrame *ref_frames, uint32_t tot_refs,
                                          PictureControlSet *pcs);

void get_av1_mv_pred_drl(struct ModeDecisionContext *ctx, BlkStruct *blk_ptr,
