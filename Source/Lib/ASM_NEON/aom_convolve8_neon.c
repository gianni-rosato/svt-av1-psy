...
static INLINE void convolve8_horiz_8tap_neon(const uint8_t *src, ptrdiff_t src_stride, uint8_t *dst,
    ...
    if (h == 4) {
        ...
        do {
            ...
            int16x4_t d0 = convolve8_4_x(s0, s1, s2, s3, s4, s5, s6, s7, filter);
            int16x4_t d1 = convolve8_4_x(s1, s2, s3, s4, s5, s6, s7, s8, filter);
            int16x4_t d2 = convolve8_4_x(s2, s3, s4, s5, s6, s7, s8, s9, filter);
            int16x4_t d3 = convolve8_4_x(s3, s4, s5, s6, s7, s8, s9, s10, filter);
        ...
        if (w == 4) {
            do {
                ...
                uint8x8_t d0 = convolve8_8_x(s0, s1, s2, s3, s4, s5, s6, s7, filter);
                uint8x8_t d1 = convolve8_8_x(s1, s2, s3, s4, s5, s6, s7, s8, filter);
                uint8x8_t d2 = convolve8_8_x(s2, s3, s4, s5, s6, s7, s8, s9, filter);
                uint8x8_t d3 = convolve8_8_x(s3, s4, s5, s6, s7, s8, s9, s10, filter);
            ...
            do {
                ...
                do {
                    ...
                    uint8x8_t d2 = convolve8_8_x(s2, s3, s4, s5, s6, s7, s8, s9, filter);
                    uint8x8_t d3 = convolve8_8_x(s3, s4, s5, s6, s7, s8, s9, s10, filter);
                    uint8x8_t d4 = convolve8_8_x(s4, s5, s6, s7, s8, s9, s10, s11, filter);
                    uint8x8_t d5 = convolve8_8_x(s5, s6, s7, s8, s9, s10, s11, s12, filter);
                    uint8x8_t d6 = convolve8_8_x(s6, s7, s8, s9, s10, s11, s12, s13, filter);
                    uint8x8_t d7 = convolve8_8_x(s7, s8, s9, s10, s11, s12, s13, s14, filter);
