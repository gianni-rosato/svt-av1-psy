...
void svt_av1_convolve_y_sr_12tap_sse2(const uint8_t *src, int src_stride,
...
void svt_av1_convolve_y_sr_sse2(const uint8_t *src, int32_t src_stride, uint8_t *dst,
  ...
  if (filter_params_y->taps > 8) {
    if (w < 8) {
      svt_av1_convolve_y_sr_c(src, src_stride, dst, dst_stride, w, h,
                              filter_params_x, filter_params_y, subpel_x_q4,
                              subpel_y_q4, conv_params);
    } else {
      svt_av1_convolve_y_sr_12tap_sse2(src, src_stride, dst, dst_stride, w, h,
...
void svt_av1_convolve_x_sr_12tap_sse2(const uint8_t *src, int src_stride,
                                  uint8_t *dst, int dst_stride, int w, int h,
...
void svt_av1_convolve_x_sr_sse2(const uint8_t *src, int32_t src_stride, uint8_t *dst,
  ...
  if (filter_params_x->taps > 8) {
    if (w < 4) {
      svt_av1_convolve_x_sr_c(src, src_stride, dst, dst_stride, w, h,
                              filter_params_x, filter_params_y, subpel_x_q4,
                              subpel_y_q4, conv_params);
    } else {
      svt_av1_convolve_x_sr_12tap_sse2(src, src_stride, dst, dst_stride, w, h,
