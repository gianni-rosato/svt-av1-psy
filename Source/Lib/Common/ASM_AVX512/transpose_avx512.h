...
static INLINE void transpose_16x16_stride_avx512(int32_t stride, const __m512i *in,
                                                 __m512i *out) {
    __m512i out1[16];
