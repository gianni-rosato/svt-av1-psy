...
SIMD_INLINE __m256i x_convolve_2tap_avx2(const __m256i data,
...
SIMD_INLINE __m256i x_convolve_4tap_avx2(const __m256i data,
...
SIMD_INLINE void jnt_y_avg_2tap_32_avx2(
...
SIMD_INLINE void jnt_y_no_avg_2tap_32_avx2(
    const uint8_t *const src, const __m256i *const coeffs, const __m256i offset,
            ...
            if (w == 8) {
                ...
                if (conv_params->do_average) {
                    if (conv_params->use_jnt_comp_avg) {
                        do {
                            src_ptr += 2 * src_stride;
                            y_convolve_4tap_16x2_avx2(src_ptr,
                                src_stride,
                                coeffs_256,
                                s_128,
                                ss_256,
            ...
            if (w == 8) {
                ...
                if (conv_params->do_average) {
                    if (conv_params->use_jnt_comp_avg) {
                        do {
                            src_ptr += 2 * src_stride;
                            y_convolve_6tap_16x2_avx2(src_ptr,
                                src_stride,
                                coeffs_256,
                                s_128,
                                ss_256,
        ...
        if (w <= 4) {
            ...
            if (w == 8) {
                ...
                if (conv_params->do_average) {
                    if (conv_params->use_jnt_comp_avg) {
                        do {
                            y_convolve_8tap_16x2_avx2(src_ptr,
                                src_stride,
                                coeffs_256,
                                s_128,
                                ss_256,
...
SIMD_INLINE void jnt_x_avg_2tap_32_avx2(const uint8_t *const src,
...
SIMD_INLINE void jnt_x_no_avg_2tap_32_avx2(const uint8_t *const src,
    const __m256i *const coeffs,
    const __m256i offset,
...
SIMD_INLINE void jnt_x_avg_6tap_32_avx2(const uint8_t *const src,
...
SIMD_INLINE void jnt_x_no_avg_6tap_32_avx2(
    const uint8_t *const src, const __m256i coeffs[3],
    const __m256i *const filt, const __m256i offset, ConvBufType *const dst) {
    __m256i r[2];
...
SIMD_INLINE void jnt_x_comp_avg_8tap_16x2_avx2(
    const uint8_t *const src, const int32_t src_stride, const __m256i coeffs[3],
    const __m256i *const filt, const __m256i factor, const __m256i offset,
    ConvBufType *const dst, const int32_t dst_stride, uint8_t *const dst8,
    const int32_t dst8_stride) {
...
SIMD_INLINE void jnt_x_no_avg_8tap_16x2_avx2(
    const uint8_t *const src, const int32_t src_stride, const __m256i coeffs[3],
    const __m256i *const filt, const __m256i offset, ConvBufType *const dst,
    const int32_t dst_stride) {
    __m256i r[2];
            ...
            if (w == 8) {
                ...
                if (conv_params->do_average) {
                    ...
                    do {
                        jnt_x_no_avg_2tap_32_avx2(
                            src_ptr, coeffs_256, offset_no_avg_256, dst);
                        jnt_x_no_avg_2tap_32_avx2(src_ptr + 32,
                            coeffs_256,
                            offset_no_avg_256,
                            dst + 32);
                        src_ptr += src_stride;
        ...
        if (is_convolve_6tap(filter_params_x->filter_ptr)) {
            ...
            if (w == 8) {
                ...
                if (conv_params->do_average) {
                    ...
                    do {
                        jnt_x_no_avg_6tap_32_avx2(src_ptr,
                            coeffs_256,
                            filt_256,
                            offset_no_avg_256,
                            dst);
            ...
            if (w == 8) {
                ...
                if (conv_params->do_average) {
                    ...
                    do {
                        jnt_x_no_avg_8tap_32_avx2(src_ptr,
                            coeffs_256,
                            filt_256,
                            offset_no_avg_256,
                            dst);
