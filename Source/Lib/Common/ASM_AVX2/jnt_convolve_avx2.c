            ...
            if (conv_params->do_average) {
                if (conv_params->use_jnt_comp_avg) {
                    ...
                    do {
                        const __m256i res = y_convolve_2tap_8x2_avx2(
                            src_ptr, src_stride, coeffs_256, s_64);
                        jnt_avg_round_store_8x2_sse2(res,
                            offset_avg_256,
                            dst,
                            dst_stride,
                            dst8,
...
static void jnt_convolve_y_4tap_avx2(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
    const InterpFilterParams *const filter_params_y, const int32_t subpel_y_q4,
    const ConvolveParams *const conv_params) {
...
static INLINE void jnt_x_comp_avg_6tap_32_avx2(
...
static INLINE void jnt_x_avg_6tap_32_avx2(const uint8_t *const src,
...
static INLINE void jnt_x_no_avg_6tap_32_avx2(const uint8_t *const src,
    const __m256i coeffs[3],
    const __m256i *const filt,
    const __m256i offset,
    ConvBufType *const dst) {
...
static INLINE void jnt_x_avg_8tap_16x2_avx2(
    const uint8_t *const src, const int32_t src_stride, const __m256i coeffs[3],
    const __m256i *const filt, const __m256i offset, ConvBufType *const dst,
    const int32_t dst_stride, uint8_t *const dst8, const int32_t dst8_stride) {
    __m256i r[2];
...
SIMD_INLINE void jnt_x_avg_8tap_32_avx2(const uint8_t *const src,
...
static void jnt_convolve_x_4tap_ssse3(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
    const InterpFilterParams *const filter_params_x, const int32_t subpel_x_q4,
    const ConvolveParams *const conv_params) {
        ...
        if (conv_params->do_average) {
            if (conv_params->use_jnt_comp_avg) {
                do {
                    jnt_x_comp_avg_6tap_16x2_avx2(src_ptr,
                        ...
                        dst8,
                        16);
                    jnt_x_comp_avg_6tap_16x2_avx2(src_ptr + 32,
                        16,
                        coeffs_256,
                        filt_256,
                        factor_256,
                ...
                do {
                    jnt_x_avg_6tap_16x2_avx2(src_ptr,
                        ...
                        dst8,
                        16);
                    jnt_x_avg_6tap_16x2_avx2(src_ptr + 32,
                        16,
                        coeffs_256,
                        filt_256,
                        offset_avg_256,
            ...
            do {
                jnt_x_no_avg_6tap_16x2_avx2(src_ptr,
                    ...
                    dst,
                    16);
                jnt_x_no_avg_6tap_16x2_avx2(src_ptr + 32,
                    16,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
        ...
        if (conv_params->do_average) {
            if (conv_params->use_jnt_comp_avg) {
                do {
                    jnt_x_comp_avg_6tap_16x2_avx2(src_ptr,
                        ...
                        dst8,
                        16);
                    jnt_x_comp_avg_6tap_16x2_avx2(src_ptr + 1 * 32,
                        16,
                        coeffs_256,
                        filt_256,
                        factor_256,
                        ...
                        dst8 + 1 * 32,
                        16);
                    jnt_x_comp_avg_6tap_16x2_avx2(src_ptr + 2 * 32,
                        16,
                        coeffs_256,
                        filt_256,
                        factor_256,
                        ...
                        dst8 + 2 * 32,
                        16);
                    jnt_x_comp_avg_6tap_16x2_avx2(src_ptr + 3 * 32,
                        16,
                        coeffs_256,
                        filt_256,
                        factor_256,
                ...
                do {
                    jnt_x_avg_6tap_16x2_avx2(src_ptr,
                        ...
                        dst8,
                        16);
                    jnt_x_avg_6tap_16x2_avx2(src_ptr + 1 * 32,
                        16,
                        coeffs_256,
                        filt_256,
                        offset_avg_256,
                        ...
                        dst8 + 1 * 32,
                        16);
                    jnt_x_avg_6tap_16x2_avx2(src_ptr + 2 * 32,
                        16,
                        coeffs_256,
                        filt_256,
                        offset_avg_256,
                        ...
                        dst8 + 2 * 32,
                        16);
                    jnt_x_avg_6tap_16x2_avx2(src_ptr + 3 * 32,
                        16,
                        coeffs_256,
                        filt_256,
                        offset_avg_256,
            ...
            do {
                jnt_x_no_avg_6tap_16x2_avx2(src_ptr,
                    ...
                    dst,
                    16);
                jnt_x_no_avg_6tap_16x2_avx2(src_ptr + 1 * 32,
                    16,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
                    dst + 1 * 32,
                    16);
                jnt_x_no_avg_6tap_16x2_avx2(src_ptr + 2 * 32,
                    16,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
                    dst + 2 * 32,
                    16);
                jnt_x_no_avg_6tap_16x2_avx2(src_ptr + 3 * 32,
                    16,
                    coeffs_256,
                    filt_256,
                    offset_no_avg_256,
