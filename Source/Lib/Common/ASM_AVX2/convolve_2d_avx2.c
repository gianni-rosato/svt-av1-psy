...
SIMD_INLINE void xy_y_round_store_8x2_avx2(const __m256i res[2],
    uint8_t *const dst,
...
SIMD_INLINE void xy_y_round_store_16x2_avx2(const __m256i res[4],
    uint8_t *const dst,
    const int32_t stride) {
        ...
        if (subpel_y_q4 != 8) {
            if (w <= 4) {
                ...
                if (w == 8) {
                    ...
                    do {
                        xy_y_convolve_2tap_32_all_avx2(im + 128,
                            s_256[0] + 0,
                            s_256[1] + 0,
                            coeffs_256,
                            dst);
            ...
            if (w == 2) {
                ...
                do {
                    const __m128i res = xy_y_convolve_2tap_2x2_half_pel_sse2(
                        im, s_32);
                ...
                do {
                    const __m128i res = xy_y_convolve_2tap_4x2_half_pel_sse2(
                        im, s_64);
                    const __m128i r = xy_y_round_half_pel_sse2(res);
                ...
                do {
                    ...
                    xy_y_convolve_2tap_half_pel_32_all_avx2(im + 32,
                        s_256[1] + 2,
                        s_256[0] + 2,
                        dst + dst_stride + 32);
                    dst += 2 * dst_stride;
                ...
                do {
                    ...
                    xy_y_convolve_2tap_half_pel_32_all_avx2(im + 32,
                        ...
                        s_256[0] + 2,
                        dst + dst_stride + 1 * 32);
                    xy_y_convolve_2tap_half_pel_32_all_avx2(im + 64,
                        s_256[1] + 4,
                        s_256[0] + 4,
                        dst + dst_stride + 2 * 32);
                    xy_y_convolve_2tap_half_pel_32_all_avx2(im + 96,
                        s_256[1] + 6,
                        s_256[0] + 6,
                        dst + dst_stride + 3 * 32);
                    dst += 2 * dst_stride;
