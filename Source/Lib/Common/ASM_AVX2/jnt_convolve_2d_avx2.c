...
SIMD_INLINE __m128i jnt_2d_comp_avg_round_4_sse2(const __m128i src) {
...
SIMD_INLINE __m128i jnt_2d_comp_avg_round_half_pel_sse2(const __m128i src) {
    const __m128i round = _mm_set1_epi16(1);
    const __m128i dst = _mm_add_epi16(src, round);
    return _mm_srai_epi16(dst, 1);
}

SIMD_INLINE __m128i jnt_2d_comp_avg_round_4x2_sse2(const __m128i src[2]) {
    const __m128i round = _mm_set1_epi32(1 << (COMPOUND_ROUND1_BITS - 1));
...
SIMD_INLINE __m256i jnt_2d_comp_avg_round_8_avx2(const __m256i src) {
...
SIMD_INLINE __m256i jnt_2d_comp_avg_round_8x2_avx2(const __m256i src[2]) {
    const __m256i round = _mm256_set1_epi32(1 << (COMPOUND_ROUND1_BITS - 1));
...
SIMD_INLINE __m256i jnt_2d_comp_avg_round_half_pel_avx2(const __m256i src) {
    const __m256i round = _mm256_set1_epi16(1);
    const __m256i dst = _mm256_add_epi16(src, round);
    return _mm256_srai_epi16(dst, 1);
}

SIMD_INLINE void jnt_2d_comp_avg_round_store_2x2_sse2(
...
SIMD_INLINE void jnt_2d_comp_avg_round_store_half_pel_2x2_sse2(
    const __m128i res, const __m128i factor, const __m128i offset,
    const ConvBufType *const dst, const int32_t dst_stride, uint8_t *const dst8,
    const int32_t dst8_stride) {
...
SIMD_INLINE void jnt_2d_comp_avg_round_store_4x2_sse2(
...
SIMD_INLINE void jnt_2d_comp_avg_round_store_half_pel_4x2_sse2(
    const __m128i res, const __m128i factor, const __m128i offset,
    const ConvBufType *const dst, const int32_t dst_stride, uint8_t *const dst8,
    const int32_t dst8_stride) {
    const __m128i r = jnt_2d_comp_avg_round_half_pel_sse2(res);
...
SIMD_INLINE __m256i jnt_2d_comp_avg_round_pack_8_avx2(const __m256i res,
...
SIMD_INLINE __m256i jnt_2d_comp_avg_round_pack_16_avx2(const __m256i res[2],
    const __m256i factor,
    const __m256i offset,
    const __m256i dst) {
...
SIMD_INLINE __m256i jnt_2d_comp_avg_round_pack_half_pel_avx2(
...
SIMD_INLINE void jnt_2d_comp_avg_round_store_4x2_avx2(
    const __m256i res, const __m256i factor, const __m256i offset,
    const ConvBufType *const dst, const int32_t dst_stride, uint8_t *const dst8,
    const int32_t dst8_stride) {
    __m128i d_128[2];
...
SIMD_INLINE void jnt_2d_comp_avg_round_store_8x2_avx2(
...
SIMD_INLINE void jnt_2d_comp_avg_round_store_half_pel_8x2_avx2(
    const __m256i res, const __m256i factor, const __m256i offset,
    const ConvBufType *const dst, const int32_t dst_stride, uint8_t *const dst8,
    const int32_t dst8_stride) {
    const __m256i d = loadu_u16_8x2_avx2(dst, dst_stride);
...
SIMD_INLINE void jnt_2d_comp_avg_round_store_16x2_avx2(
...
SIMD_INLINE void jnt_2d_comp_avg_round_store_half_pel_16x2_avx2(
    const __m256i res[2], const __m256i factor, const __m256i offset,
    const ConvBufType *const dst, const int32_t dst_stride, uint8_t *const dst8,
    const int32_t dst8_stride) {
    __m256i d[2];
...
SIMD_INLINE void jnt_2d_comp_avg_2tap_32_avx2(
    const int16_t *src, const __m256i s0[2], __m256i s1[2],
    const __m256i coeffs[1], const __m256i factor, const __m256i offset,
    ConvBufType *const dst, uint8_t *const dst8) {
    __m256i r[4];

    xy_y_convolve_2tap_32_avx2(src, s0, s1, coeffs, r);
    jnt_2d_comp_avg_round_store_32_avx2(
        r + 0, r + 2, factor, offset, dst, dst8);
}

SIMD_INLINE void jnt_2d_comp_avg_2tap_half_pel_32_avx2(
    const int16_t *src, const __m256i s0[2], __m256i s1[2],
    ...
    jnt_2d_comp_avg_round_store_half_pel_32_avx2(r, factor, offset, dst, dst8);
}

SIMD_INLINE __m128i jnt_2d_round_4_sse2(const __m128i src,
...
SIMD_INLINE __m128i jnt_2d_round_half_pel_sse2(const __m128i src,
    const __m128i offset) {
    const __m128i dst = _mm_add_epi16(src, offset);
    return _mm_srai_epi16(dst, 1);
}

SIMD_INLINE __m128i jnt_2d_round_4x2_sse2(const __m128i src[2],
    const __m128i offset) {
...
SIMD_INLINE __m256i jnt_2d_round_4x2_avx2(const __m256i src,
    const __m256i offset) {
...
SIMD_INLINE __m256i jnt_2d_round_16_avx2(const __m256i src[2],
    const __m256i offset) {
...
SIMD_INLINE __m256i jnt_2d_round_half_pel_avx2(const __m256i src,
    const __m256i offset) {
    const __m256i dst0 = _mm256_add_epi16(src, offset);
    return _mm256_srai_epi16(dst0, 1);
}

SIMD_INLINE void jnt_2d_avg_round_store_2x2_sse2(
...
SIMD_INLINE void jnt_2d_avg_round_store_half_pel_2x2_sse2(
    const __m128i res, const __m128i offset, const ConvBufType *const dst,
    const int32_t dst_stride, uint8_t *const dst8, const int32_t dst8_stride) {
...
SIMD_INLINE void jnt_2d_avg_round_store_4x2_sse2(
...
SIMD_INLINE void jnt_2d_avg_round_store_half_pel_4x2_sse2(
    const __m128i res, const __m128i offset, const ConvBufType *const dst,
    const int32_t dst_stride, uint8_t *const dst8, const int32_t dst8_stride) {
    const __m128i r = jnt_2d_round_half_pel_sse2(res, offset);
    __m128i d;
...
SIMD_INLINE void jnt_2d_avg_round_store_4x2_avx2(
...
SIMD_INLINE void jnt_2d_avg_round_store_8x2_avx2(
...
SIMD_INLINE void jnt_2d_avg_round_store_half_pel_8x2_avx2(
    const __m256i res, const __m256i offset, const ConvBufType *const dst,
    const int32_t dst_stride, uint8_t *const dst8, const int32_t dst8_stride) {
...
SIMD_INLINE void jnt_2d_avg_round_store_16x2_avx2(
...
SIMD_INLINE void jnt_2d_avg_round_store_half_pel_16x2_avx2(
    const __m256i res[2], const __m256i offset, const ConvBufType *const dst,
    const int32_t dst_stride, uint8_t *const dst8, const int32_t dst8_stride) {
    __m256i r[2], d[2];
...
SIMD_INLINE void jnt_2d_avg_round_store_half_pel_32_avx2(
    const __m256i res[2], const __m256i offset, const ConvBufType *const dst,
    uint8_t *const dst8) {
    __m256i r[2], d[2];
...
SIMD_INLINE void jnt_2d_avg_2tap_32_avx2(const int16_t *src,
    ...
    xy_y_convolve_2tap_32_avx2(src, s0, s1, coeffs, r);
    jnt_2d_avg_round_store_32_avx2(r + 0, r + 2, offset, dst, dst8);
}

SIMD_INLINE void jnt_2d_avg_2tap_half_pel_32_avx2(
    const int16_t *src, const __m256i s0[2], __m256i s1[2],
    const __m256i offset, ConvBufType *const dst, uint8_t *const dst8) {
    __m256i r[2];

    xy_y_convolve_2tap_half_pel_32_avx2(src, s0, s1, r);
    jnt_2d_avg_round_store_half_pel_32_avx2(r, offset, dst, dst8);
}

SIMD_INLINE void jnt_2d_no_avg_round_store_2x2_sse2(const __m128i res,
    const __m128i offset,
    ConvBufType *const dst,
...
SIMD_INLINE void jnt_2d_no_avg_round_store_half_pel_2x2_sse2(
...
SIMD_INLINE void jnt_2d_no_avg_round_store_4x2_sse2(const __m128i res[2],
    const __m128i offset,
    ConvBufType *const dst,
    const int32_t dst_stride) {
...
SIMD_INLINE void jnt_2d_no_avg_round_store_4x2_avx2(const __m256i res,
    const __m256i offset,
    ConvBufType *const dst,
    const int32_t dst_stride) {
...
SIMD_INLINE void jnt_2d_no_avg_round_store_half_pel_4x2_sse2(
    const __m128i res, const __m128i offset, ConvBufType *const dst,
    const int32_t dst_stride) {
    const __m128i d = jnt_2d_round_half_pel_sse2(res, offset);
    store_u16_4x2_sse2(d, dst, dst_stride);
...
SIMD_INLINE void jnt_2d_no_avg_round_store_8x2_avx2(const __m256i res[2],
    const __m256i offset,
    ConvBufType *const dst,
    const int32_t dst_stride) {
...
SIMD_INLINE void jnt_2d_no_avg_round_store_half_pel_8x2_avx2(
...
SIMD_INLINE void jnt_2d_no_avg_round_store_16x2_avx2(const __m256i res[4],
    const __m256i offset,
    ConvBufType *const dst,
    const int32_t dst_stride) {
...
SIMD_INLINE void jnt_2d_no_avg_round_store_half_pel_16x2_avx2(
...
SIMD_INLINE void jnt_2d_no_avg_round_store_32_avx2(const __m256i r0[2],
    const __m256i r1[2],
    const __m256i offset,
    ConvBufType *const dst) {
...
SIMD_INLINE void jnt_2d_no_avg_round_store_half_pel_32_avx2(
    const __m256i res[2], const __m256i offset, ConvBufType *const dst) {
    const __m256i d0 = jnt_2d_round_half_pel_avx2(res[0], offset);
    const __m256i d1 = jnt_2d_round_half_pel_avx2(res[1], offset);
    jnt_no_avg_store_16x2_avx2(d0, d1, dst, 16);
...
SIMD_INLINE void jnt_2d_no_avg_2tap_32_avx2(const int16_t *src,
    const __m256i s0[2], __m256i s1[2],
    const __m256i coeffs[1],
    const __m256i offset,
    ConvBufType *const dst) {
    ...
    xy_y_convolve_2tap_32_avx2(src, s0, s1, coeffs, r);
    jnt_2d_no_avg_round_store_32_avx2(r + 0, r + 2, offset, dst);
}

SIMD_INLINE void jnt_2d_no_avg_2tap_half_pel_32_all_avx2(
    const int16_t *src, const __m256i s0[2], __m256i s1[2],
    const __m256i offset, ConvBufType *const dst) {
    __m256i r[2];

    xy_y_convolve_2tap_half_pel_32_avx2(src, s0, s1, r);
    jnt_2d_no_avg_round_store_half_pel_32_avx2(r, offset, dst);
}
...
void eb_av1_jnt_convolve_2d_avx2(const uint8_t *src, int32_t src_stride,
    ...
    if (is_convolve_2tap(filter_params_x->filter_ptr)) {
        ...
        if (w <= 8) {
            ...
            if (w == 2) {
                ...
                do {
                    const __m128i r = x_convolve_2tap_4x2_ssse3(
                        src_ptr, src_stride, coeffs_128);
                ...
                do {
                    ...
                    x_convolve_2tap_8x2_ssse3(
                        src_ptr, src_stride, coeffs_128, r);
    ...
    __m128i offset_avg_128, offset_no_avg_128;
    __m256i offset_avg_256, offset_no_avg_256;
    ...
    if (tap_y == 2) {
        ...
        if (subpel_y_q4 != 8) {
            const int32_t offset_avg =
                (1 << (round_1 - 1)) + (1 << (round_bits + round_1)) -
                (1 << offset_bits) - (1 << (offset_bits - 1));
            const int32_t offset_no_avg = (1 << (round_1 - 1)) +
                (1 << offset_bits) +
                (1 << (offset_bits - 1));
            offset_avg_128 = _mm_set1_epi32(offset_avg);
            offset_no_avg_128 = _mm_set1_epi32(offset_no_avg);
            offset_avg_256 = _mm256_set1_epi32(offset_avg);
            offset_no_avg_256 = _mm256_set1_epi32(offset_no_avg);
            ...
            if (w <= 4) {
                ...
                if (w == 2) {
                    ...
                    if (conv_params->do_average) {
                        if (conv_params->use_jnt_comp_avg) {
                            do {
                                const __m128i res = xy_y_convolve_2tap_2x2_sse2(
                                    im, s_32, coeffs_128);
                ...
                if (w == 8) {
                    ...
                    if (conv_params->do_average) {
                        if (conv_params->use_jnt_comp_avg) {
                            ...
                            do {
                                jnt_2d_avg_2tap_32_avx2(im + 32,
                                    ...
                                    dst,
                                    dst8);
                                jnt_2d_avg_2tap_32_avx2(im + 2 * 32,
                                    s_256[1],
                                    s_256[0],
                                    coeffs_256,
                                    offset_avg_256,
                        ...
                        do {
                            jnt_2d_no_avg_2tap_32_avx2(im + 32,
                                s_256[0],
                                s_256[1],
                                coeffs_256,
                                offset_no_avg_256,
                                dst);
                            jnt_2d_no_avg_2tap_32_avx2(im + 2 * 32,
                                s_256[1],
                                s_256[0],
                                coeffs_256,
                                offset_no_avg_256,
                    ...
                    if (conv_params->do_average) {
                        ...
                        do {
                            jnt_2d_no_avg_2tap_32_avx2(im + 64,
                                s_256[0] + 0,
                                s_256[1] + 0,
                                coeffs_256,
                                offset_no_avg_256,
                                dst);
                            jnt_2d_no_avg_2tap_32_avx2(im + 96,
                                s_256[0] + 2,
                                s_256[1] + 2,
                                coeffs_256,
                                offset_no_avg_256,
                    ...
                    if (conv_params->do_average) {
                        if (conv_params->use_jnt_comp_avg) {
                            ...
                            do {
                                jnt_2d_avg_2tap_32_avx2(im + 4 * 32,
                                    s_256[0] + 0,
                                    s_256[1] + 0,
                                    coeffs_256,
                                    offset_avg_256,
                                    dst,
                                    dst8);
                                jnt_2d_avg_2tap_32_avx2(im + 5 * 32,
                                    s_256[0] + 2,
                                    s_256[1] + 2,
                                    coeffs_256,
                                    offset_avg_256,
                                    dst + 1 * 32,
                                    dst8 + 1 * 32);
                                jnt_2d_avg_2tap_32_avx2(im + 6 * 32,
                                    s_256[0] + 4,
                                    s_256[1] + 4,
                                    coeffs_256,
                                    offset_avg_256,
                                    dst + 2 * 32,
                                    dst8 + 2 * 32);
                                jnt_2d_avg_2tap_32_avx2(im + 7 * 32,
                                    s_256[0] + 6,
                                    s_256[1] + 6,
                                    coeffs_256,
                                    offset_avg_256,
                        ...
                        do {
                            jnt_2d_no_avg_2tap_32_avx2(im + 4 * 32,
                                s_256[0] + 0,
                                s_256[1] + 0,
                                coeffs_256,
                                offset_no_avg_256,
                                dst);
                            jnt_2d_no_avg_2tap_32_avx2(im + 5 * 32,
                                s_256[0] + 2,
                                s_256[1] + 2,
                                coeffs_256,
                                offset_no_avg_256,
                                dst + 1 * 32);
                            jnt_2d_no_avg_2tap_32_avx2(im + 6 * 32,
                                s_256[0] + 4,
                                s_256[1] + 4,
                                coeffs_256,
                                offset_no_avg_256,
                                dst + 2 * 32);
                            jnt_2d_no_avg_2tap_32_avx2(im + 7 * 32,
                                s_256[0] + 6,
                                s_256[1] + 6,
                                coeffs_256,
                                offset_no_avg_256,
            ...
            const int32_t offset_avg_half_pel =
                (1 << (round_1 - COMPOUND_ROUND1_BITS)) +
                (1 << (round_bits + round_1 - COMPOUND_ROUND1_BITS + 1)) -
                (1 << (offset_bits - COMPOUND_ROUND1_BITS + 1)) -
                (1 << (offset_bits - COMPOUND_ROUND1_BITS));
            const int32_t offset_no_avg_half_pel =
                (1 << (round_1 - COMPOUND_ROUND1_BITS)) +
                (1 << (offset_bits - COMPOUND_ROUND1_BITS + 1)) +
                (1 << (offset_bits - COMPOUND_ROUND1_BITS));

            offset_avg_128 = _mm_set1_epi16(offset_avg_half_pel);
            offset_no_avg_128 = _mm_set1_epi16(offset_no_avg_half_pel);
            offset_avg_256 = _mm256_set1_epi16(offset_avg_half_pel);
            offset_no_avg_256 = _mm256_set1_epi16(offset_no_avg_half_pel);
            ...
            if (w == 2) {
                ...
                if (conv_params->do_average) {
                    if (conv_params->use_jnt_comp_avg) {
                        do {
                            jnt_2d_comp_avg_2tap_half_pel_32_avx2(
                                im + 32,
                                s_256[0],
                                s_256[1],
                                factor_256,
                        ...
                        do {
                            jnt_2d_avg_2tap_half_pel_32_avx2(im + 32,
                                s_256[0],
                                s_256[1],
                                offset_avg_256,
                                dst,
                                dst8);
                            jnt_2d_avg_2tap_half_pel_32_avx2(
                                im + 2 * 32,
                                s_256[1],
                                s_256[0],
                                offset_avg_256,
                    ...
                    do {
                        jnt_2d_no_avg_2tap_half_pel_32_all_avx2(
                            im + 32,
                            s_256[0],
                            s_256[1],
                            offset_no_avg_256,
                ...
                if (conv_params->do_average) {
                    if (conv_params->use_jnt_comp_avg) {
                        ...
                        do {
                            jnt_2d_avg_2tap_half_pel_32_avx2(im + 64,
                                s_256[0] + 0,
                                s_256[1] + 0,
                                offset_avg_256,
                                dst,
                                dst8);
                            jnt_2d_avg_2tap_half_pel_32_avx2(im + 96,
                                s_256[0] + 2,
                                s_256[1] + 2,
                                offset_avg_256,
                                dst + 32,
                ...
                if (conv_params->do_average) {
                    if (conv_params->use_jnt_comp_avg) {
                        ...
                        do {
                            jnt_2d_avg_2tap_half_pel_32_avx2(im + 4 * 32,
                                s_256[0] + 0,
                                s_256[1] + 0,
                                offset_avg_256,
                                dst,
                                dst8);
                            jnt_2d_avg_2tap_half_pel_32_avx2(im + 5 * 32,
                                s_256[0] + 2,
                                s_256[1] + 2,
                                offset_avg_256,
                                dst + 1 * 32,
                                dst8 + 1 * 32);
                            jnt_2d_avg_2tap_half_pel_32_avx2(im + 6 * 32,
                                s_256[0] + 4,
                                s_256[1] + 4,
                                offset_avg_256,
                                dst + 2 * 32,
                                dst8 + 2 * 32);
                            jnt_2d_avg_2tap_half_pel_32_avx2(im + 7 * 32,
                                s_256[0] + 6,
                                s_256[1] + 6,
                                offset_avg_256,
                                dst + 3 * 32,
            ...
            if (w == 2) {
                ...
                if (w == 4) {
					...
					if (conv_params->do_average) {
						if (conv_params->use_jnt_comp_avg) {
							do {
								xy_y_convolve_6tap_16x2_avx2(im,
									16,
									s_256,
									ss_256,
									tt_256,
                    ...
                    __m256i s_256[2][6], ss_256[2][6], tt_256[2][6], r0[4],
                        r1[4];
            ...
            if (w == 2) {
                ...
                if (w == 4) {
					...
					if (conv_params->do_average) {
						if (conv_params->use_jnt_comp_avg) {
							do {
								xy_y_convolve_8tap_16x2_avx2(im,
									16,
									coeffs_256,
									s_256,
									ss_256,
