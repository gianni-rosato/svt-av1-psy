...
void svt_aom_hadamard_16x16_avx2(const int16_t* src_diff, ptrdiff_t src_stride,
    int32_t* coeff) {
    hadamard_16x16_avx2(src_diff, src_stride, coeff, 1);
}

void svt_aom_hadamard_32x32_avx2(const int16_t* src_diff, ptrdiff_t src_stride,
    int32_t* coeff) {
