      ...
      for (j = 0; j < w; j += 8) {
        ...
        if (do_average) {
          ...
          const __m128i comp_avg_res_lo =
              highbd_comp_avg_sse4_1(&data_ref_0_lo, &res_unsigned_lo, &wt0, &wt1, use_jnt_comp_avg);
          ...
          const __m128i comp_avg_res_hi =
              highbd_comp_avg_sse4_1(&data_ref_0_hi, &res_unsigned_hi, &wt0, &wt1, use_jnt_comp_avg);
...
void svt_av1_highbd_jnt_convolve_2d_sse4_1(
    const uint16_t *src, int32_t src_stride, uint16_t *dst16, int32_t dst16_stride, int32_t w,
    int32_t h, const InterpFilterParams *filter_params_x, const InterpFilterParams *filter_params_y,
    const int32_t subpel_x_q4, const int32_t subpel_y_q4, ConvolveParams *conv_params, int32_t bd) {
    if (w <= 4) {
        ...
        if (w < 8) {
          if (do_average) {
            ...
            const __m128i comp_avg_res =
                highbd_comp_avg_sse4_1(&data_ref_0, &res_unsigned_lo, &wt0, &wt1, use_jnt_comp_avg);
          ...
          if (do_average) {
            ...
            _mm_store_si128((__m128i *)(&dst16[i * dst16_stride + j]), res_clip);
          } else {
            const __m128i res_16b =
