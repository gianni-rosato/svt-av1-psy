...
static INLINE void highbd_filter_src_pixels(const __m128i *src, const __m128i *src2, __m128i *tmp,
    ...
    const __m128i round_const =
        _mm_set1_epi32((1 << offset_bits_horiz) + ((1 << reduce_bits_horiz) >> 1));
    ...
    res_even =
        _mm_sra_epi32(_mm_add_epi32(res_even, round_const), _mm_cvtsi32_si128(reduce_bits_horiz));
...
static INLINE void highbd_warp_horizontal_filter_alpha0_beta0(const uint16_t *ref, __m128i *tmp,
...
static INLINE void highbd_warp_horizontal_filter_alpha0(const uint16_t *ref, __m128i *tmp,
                                                        int stride, int32_t ix4, int32_t iy4,
                                                        int32_t sx4, int alpha, int beta,
                                                        int p_height, int height, int i,
                                                        const int offset_bits_horiz,
...
static INLINE void highbd_warp_horizontal_filter_beta0(const uint16_t *ref, __m128i *tmp,
                                                       int stride, int32_t ix4, int32_t iy4,
                                                       int32_t sx4, int alpha, int beta,
                                                       int p_height, int height, int i,
                                                       const int offset_bits_horiz,
...
static INLINE void highbd_warp_horizontal_filter(const uint16_t *ref, __m128i *tmp, int stride,
...
static INLINE void highbd_prepare_warp_horizontal_filter(const uint16_t *ref, __m128i *tmp,
                                                         int stride, int32_t ix4, int32_t iy4,
                                                         int32_t sx4, int alpha, int beta,
                                                         int p_height, int height, int i,
                                                         const int offset_bits_horiz,
                                                         const int reduce_bits_horiz) {
    if (alpha == 0 && beta == 0)
        highbd_warp_horizontal_filter_alpha0_beta0(ref,
                                                   tmp,
                                                   stride,
                                                   ix4,
                                                   iy4,
        ...
        highbd_warp_horizontal_filter_alpha0(ref,
                                             tmp,
                                             stride,
                                             ix4,
                                             iy4,
        ...
        highbd_warp_horizontal_filter_beta0(ref,
                                            tmp,
                                            stride,
                                            ix4,
                                            iy4,
        ...
        highbd_warp_horizontal_filter(ref,
                                      tmp,
                                      stride,
                                      ix4,
                                      iy4,
    ...
    for (i = 0; i < p_height; i += 8) {
        for (j = 0; j < p_width; j += 8) {
            ...
            if (ix4 <= -7) {
                ...
                highbd_prepare_warp_horizontal_filter(ref,
                                                      tmp,
                                                      stride,
                                                      ix4,
                                                      iy4,
            ...
            for (k = -4; k < AOMMIN(4, p_height - i - 4); ++k) {
                ...
                if (conv_params->is_compound) {
                    ...
                    const __m128i res_lo_round =
                        _mm_srai_epi32(_mm_add_epi32(res_lo, round_const), reduce_bits_vert);
