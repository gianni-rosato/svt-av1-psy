    ...
    uint32_t  width)
{
    ...
    for (row = 0; row < height; row++)
    {
        ...
        for (col = 0; col < width; col += 4)
        {
            ...
            s = _mm256_insert_epi32(s, *(int32_t *)(src + i), 0);
            r1 = _mm256_insert_epi32(r1, *(int32_t *)(ref1 + i), 0);
            r2 = _mm256_insert_epi32(r2, *(int32_t *)(ref2 + i), 0);
    ...
    temp2 = _mm_shuffle_epi32(temp1, 0xc6);
    temp1 = _mm_add_epi64(temp1, temp2);
    return _mm_cvtsi128_si32(temp1);
}
