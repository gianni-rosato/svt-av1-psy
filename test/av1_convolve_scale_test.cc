...
class ConvolveScaleTestBase : public ::testing::Test {
 public:
  ...
  virtual void TearDown() { aom_clear_system_state(); }
...
class LowBDConvolveScaleTest
 ...
 public:
  ...
  void RunOne(bool ref) {
    ...
    if (ref) {
      svt_av1_convolve_2d_scale_c(src, src_stride, dst, dst_stride, width_, height_,
...
class HighBDConvolveScaleTest
 ...
 public:
  ...
  void RunOne(bool ref) {
    ...
    if (ref) {
      svt_av1_highbd_convolve_2d_scale_c(
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Combine(::testing::Values(svt_av1_highbd_convolve_2d_scale_sse4_1),
                       ::testing::ValuesIn(kBlockDim),
                       ::testing::ValuesIn(kNTaps), ::testing::ValuesIn(kNTaps),
