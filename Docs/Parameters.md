...
| **Tune**                         | --tune                      | [0,3]                          | 2           | Specifies whether to use PSNR, VQ or SSIM as the tuning metric [0 = VQ, 1 = PSNR, 2 = SSIM, 3 = SSIM with Subjective Quality Tuning]|
| **Sharpness**                    | --sharpness                 | [0-7]                          | 0           | Bias towards block sharpness in rate-distortion optimization of transform coefficients                                                       |
