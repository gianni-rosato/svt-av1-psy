...
| **KeyframeTemporalFilteringStrength**  |  --kftf-strength      | [0-4]                          | 0           | Manually adjust temporal filtering strength for keyframes. Higher values = stronger temporal filtering        |
