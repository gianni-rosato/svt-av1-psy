...
| **LambdaScaleFactors**           | --lambda-scale-factors           | [0- ]      | '64,...,64' | list of scale factors for lambda values used for different SvtAv1FrameUpdateType, separated by `,` divide by 128 is the actual scale factor in float |
