...
| **FastDecode**                   | --fast-decode               | [0,2]                          | 0           | Tune settings to output bitstreams that can be decoded faster, [0 = OFF, 1 = ON, 2 = ON (Fastest)]. Defaults to 5 temporal layers structure but may override with --hierarchical-levels|
