...
| **KeyframeTemporalFilteringStrength**  |  --kftf-strength      | [0-4]                          | 1           | Manually adjust temporal filtering strength for keyframes. Higher values = stronger temporal filtering        |
